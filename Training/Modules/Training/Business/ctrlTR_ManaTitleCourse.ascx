<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_ManaTitleCourse.ascx.vb"
    Inherits="Training.ctrlTR_ManaTitleCourse" %>
         ...
         <%--   <tlk:RadPane ID="RadPane4" runat="server" Height="33px" Scrolling="None">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid ID="rgData" runat="server" Height="100%">
                    ...
                    <MasterTableView DataKeyNames="HU_EMPLOYEE_ID" ClientDataKeyNames="HU_EMPLOYEE_ID">
                        <Columns>
                            <tlk:GridClientSelectColumn UniqueName="cbStatus" HeaderStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                            </tlk:GridClientSelectColumn>
                            <tlk:GridBoundColumn DataField="ID" Visible="false" />
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã nhân viên %>" DataField="HU_EMPLOYEE_CODE"
                                SortExpression="HU_EMPLOYEE_CODE" UniqueName="HU_EMPLOYEE_CODE" />
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Họ và tên %>" DataField="HU_EMPLOYEE_NAME"
                                SortExpression="HU_EMPLOYEE_NAME" UniqueName="HU_EMPLOYEE_NAME" />
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenNew() {
            var oWindow = radopen('Dialog.aspx?mid=Training&fid=ctrlTR_ManaTitleCourseNewEdit&group=Business&noscroll=1', "rwPopup");
            var pos = $("html").offset();
        ...
        function OpenEdit() {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Training&fid=ctrlTR_ManaTitleCourseNewEdit&group=Business&noscroll=1&ID=' + id, "rwPopup");
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize($(window).width(), $(window).height());
            return 2;

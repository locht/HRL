    ...
    <script type="text/javascript">
        ...
        function SizeToFit(resize) {
            ...
            window.setTimeout(function () {
                ...
                if (i1 == 0) {
                    radopen('Dialog.aspx?mid=Training&fid=ctrlAT_DBCourse&group=Dashboard&width=' + (oWnd1.get_width()) + '&height=' + (oWnd1.get_height() - 30) + "&noscroll=1&resize=" + resize, "rw1");
                    i1 = 1;
                }
                ...
                if (i2 == 0) {
                    radopen('Dialog.aspx?mid=Training&fid=ctrlAT_DBDiligence&group=Dashboard&width=' + (oWnd1.get_width()) + '&height=' + (oWnd1.get_height() - 30) + "&noscroll=1&resize=" + resize, "rw2");
                    i2 = 1;
                }

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_DBDiligence.ascx.vb"
    Inherits="Training.ctrlTR_DBDiligence" %>
...
<div class="box-headchart">
    <span class="headchart"><%# Translate("Thống kê chuyên cần đào tạo")%></span>
</div>
...
//                oWnd.setUrl('Dialog.aspx?mid=Training&fid=ctrlTR_DBDiligence&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();

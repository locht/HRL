<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_DBFormRank.ascx.vb"
    Inherits="Training.ctrlTR_DBFormRank" %>
...
<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Thống kê xếp loại học viên sau khóa đào tạo")%></span>
</div>
...
//                oWnd.setUrl('Dialog.aspx?mid=Training&fid=ctrlTR_DBFormRank&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_DBFormCost.ascx.vb"
    Inherits="Training.ctrlTR_DBFormCost" %>
...
<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Thống kê chi phí đào tạo theo loại hình đào tạo")%></span>
</div>
<div id="container" style="max-width: 225px; height: 225px; margin: 0 auto">
</div>
...
//                oWnd.setUrl('Dialog.aspx?mid=Training&fid=ctrlTR_DBFormCost&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();

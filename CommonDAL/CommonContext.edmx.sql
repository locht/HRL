...
-- --------------------------------------------------
-- Date Created: 12/04/2019 3:06:29 PM
...
-- Creating table 'AT_SIGN'
CREATE TABLE "dbo"."AT_SIGN" (
   "ID" NUMBER(38,0) NOT NULL,
   "CODE" NCLOB NULL,
   "NAME" NCLOB NULL,
   "START_DATE" DATE NULL,
   "END_DATE" DATE NULL,
   "ORDNO" NUMBER(38,0) NULL,
   "NOTE" NCLOB NULL,
   "STATUS" NUMBER(38,0) NOT NULL,
   "AT_GSIGNID" NCLOB NULL,
   "AT_SIGNTYPEID" NCLOB NULL,
   "AT_SIGNMODEID" NCLOB NULL,
   "CREATE_DATE" DATE NULL,
   "CREATE_BY" NCLOB NULL,
   "CREATE_LOG" NCLOB NULL,
   "MODIFY_DATE" DATE NULL,
   "MODIFY_BY" NCLOB NULL,
   "MODIFY_LOG" NCLOB NULL,
   "DISPLAY" NUMBER(38,0) NULL,
   "NAME_EN" NCLOB NULL,
   "IMPORT" NUMBER(38,0) NULL,
   "IS_SUM" NUMBER(38,0) NULL,
   "IS_DELETED" NUMBER(38,0) NULL,
   "NUMBER_LEAVE" NUMBER(38,0) NULL,
   "NAME_SIGN" NCLOB NULL,
   "TIME_SIGN" NUMBER(38,0) NULL,
   "IMPORT_SIGN" NUMBER(38,0) NULL
);
...
-- Creating primary key on "ID"in table 'AT_SIGN'
ALTER TABLE "dbo"."AT_SIGN"
ADD CONSTRAINT "PK_AT_SIGN"
   PRIMARY KEY ("ID" )
   ENABLE
   VALIDATE;

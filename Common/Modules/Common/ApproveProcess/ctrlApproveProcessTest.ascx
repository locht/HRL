<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlApproveProcessTest.ascx.vb"
    Inherits="Common.ctrlApproveProcessTest" %>
<style type="text/css">
    ...
    <tlk:RadPane ID="RadPane1" runat="server" Height="100px" Scrolling="None">
        ...
        <asp:ValidationSummary ID="valSum" runat="server" />
            <table class="table-form">
                <tr>
                    <td class="lb" id="celllblName" runat="server">
                    <asp:Label ID="lblName" runat="server" Text="Label"></asp:Label>
                       <span class="lbReq">*</span>
                    </td>
                    <td id="celltxtName" runat="server">

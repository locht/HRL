...
Partial Public Class ctrlOtherListGroup
    ...
    '''<summary>
    '''tbarOtherListGroups control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents tbarOtherListGroups As Global.Telerik.Web.UI.RadToolBar
    ...
    '''<summary>
    '''txtOtherListGroupName control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtOtherListGroupName As Global.Telerik.Web.UI.RadTextBox
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents reqGroupName As Global.System.Web.UI.WebControls.RequiredFieldValidator
    ...
    '''<summary>
    '''rgOtherListGroup control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rgOtherListGroup As Global.Telerik.Web.UI.RadGrid

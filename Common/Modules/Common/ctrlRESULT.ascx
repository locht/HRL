...
<tlk:RadSplitter runat="server" ID="RadSplitter1" Width="100%" Height="100%">
    <tlk:RadPane ID="RadPaneGrid" runat="server" Scrolling="Both" Width="100%" Height="300px">
        <tlk:RadTextBox ID="rtbLog" runat="server" Width="100%" TextMode="MultiLine" Rows="50">
        </tlk:RadTextBox>
    </tlk:RadPane>   
</tlk:RadSplitter>

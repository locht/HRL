...
Partial Public Class ctrlSE_LdapConfiguration
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtLDAP As Global.Telerik.Web.UI.RadTextBox
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtDomainName As Global.Telerik.Web.UI.RadTextBox
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtBaseDN As Global.Telerik.Web.UI.RadTextBox

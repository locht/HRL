        ...
        <tlk:RadPanelBar runat="server" ID="RadPanelBar1" Width="100%" ExpandMode="MultipleExpandedItems"
            ...
            <Items>
                <tlk:RadPanelItem Expanded="true" Text="<%$ Translate: Tùy chỉnh Control %>">
                    <ContentTemplate>
                        <tlk:RadGrid PageSize="20" ID="rgListControls" runat="server" AllowMultiRowEdit="true"
                            AllowSorting="false" AllowScroll="true">
                            <ClientSettings EnableRowHoverStyle="true">
                                <Selecting AllowRowSelect="true" />
                            </ClientSettings>
                            <MasterTableView ClientDataKeyNames="Ctl_ID,Label_text" DataKeyNames="Ctl_ID,Label_ID,Label_text,Is_Visible,Is_Validator,ErrorMessage,ErrorTooltip"
            ...
            <Items>
                <tlk:RadPanelItem Expanded="true" Text="<%$ Translate: Tùy chỉnh Grid %>">
                    <ContentTemplate>
                        <tlk:RadGrid PageSize="20" ID="rgListGrid" runat="server" AllowMultiRowEdit="true"
                            AllowSorting="false" AllowScroll="true">
                            <MasterTableView ClientDataKeyNames="ID,Name" DataKeyNames="ID,Name,Is_Visible,Width,OrderBy"
                                EditMode="InPlace" EditFormSettings-EditFormType="AutoGenerated">
                                <Columns>
                                    <tlk:GridClientSelectColumn UniqueName="cbStatus" HeaderStyle-HorizontalAlign="Center"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30px" />

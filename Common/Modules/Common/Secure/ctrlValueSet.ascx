        ...
        <tlk:RadGrid ID="rgValueSets" runat="server" AllowFilteringByColumn="True" AllowMultiRowSelection="True"
            ...
            <MasterTableView ClientDataKeyNames="FLEX_VALUE_SET_ID,FLEX_VALUE_SET_NAME,DESCRIPTION,TYPE_ID,TYPE,DATA_TYPE,CODE"
                ...
                <Columns>
                    ...
                    <tlk:GridBoundColumn DataField="CODE" HeaderText="<%$ Translate: CM_CTRLVALUESET_VALUESET_CODE %>" EmptyDataText=""
                        SortExpression="CODE" UniqueName="CODE" FilterControlWidth="90%">
                        <HeaderStyle HorizontalAlign="Center" />
                    </tlk:GridBoundColumn>
                    <tlk:GridBoundColumn DataField="FLEX_VALUE_SET_NAME" HeaderText="<%$ Translate: CM_CTRLVALUESET_FLEX_VALUE_SET_NAME %>" EmptyDataText=""
                        SortExpression="FLEX_VALUE_SET_NAME" UniqueName="FLEX_VALUE_SET_NAME" FilterControlWidth="90%">
                        <HeaderStyle HorizontalAlign="Center" />
                    </tlk:GridBoundColumn>
                    <tlk:GridBoundColumn DataField="DESCRIPTION" HeaderText="<%$ Translate: CM_CTRLVALUESET_DESCRIPTION %>" EmptyDataText=""
                        SortExpression="DESCRIPTION" UniqueName="DESCRIPTION"  FilterControlWidth="90%">
                        <HeaderStyle HorizontalAlign="Center" />
                    </tlk:GridBoundColumn>
                    ...
                    <tlk:GridBoundColumn DataField="TYPE" HeaderText="<%$ Translate: CM_CTRLVALUESET_TYPE %>" SortExpression="TYPE"
                        UniqueName="TYPE"  FilterControlWidth="90%">
                        <HeaderStyle HorizontalAlign="Center" />
                    </tlk:GridBoundColumn>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenValueSetT() {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Common&fid=ctrlValueSetT&group=Define&noscroll=1&vsName=' + vsName, "rwPopup");
            var pos = $("html").offset();
        ...
        function OpenValueSetI() {
            ...
            var vsName = $find('<%# rgValueSets.ClientID%>').get_masterTableView().get_selectedItems()[0].getDataKeyValue('FLEX_VALUE_SET_NAME');
            var oWindow = radopen('Dialog.aspx?mid=Common&fid=ctrlValueSetI&group=Define&noscroll=1&vsName=' + vsName, "rwPopup");
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize($(window).width(), $(window).height());
            return 0;

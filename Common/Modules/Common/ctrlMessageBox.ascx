    ...
    <ContentTemplate>
        ...
        <p>
            ...
            <div style="margin: 0px 10px 10px 10px; text-align: center;">
                <tlk:RadButton EnableEmbeddedSkins="false" ID="btnYES" runat="server" Width="60px" Text="<%$ Translate: Có %>"
                    Font-Bold="true" CausesValidation="false">
                </tlk:RadButton>
                <tlk:RadButton EnableEmbeddedSkins="false" ID="btnNO" runat="server" Width="60px" Text="<%$ Translate: Không %>"
                    Font-Bold="true" CausesValidation="false">
                </tlk:RadButton>
            </div>
        </tlk:RadAjaxPanel>

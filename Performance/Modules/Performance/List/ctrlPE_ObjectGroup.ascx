<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPE_ObjectGroup.ascx.vb"
    Inherits="Performance.ctrlPE_ObjectGroup" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="reqCode" ControlToValidate="txtCode" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải nhập Mã nhóm đối tượng %>" ToolTip="<%$ Translate: Bạn phải nhập Mã nhóm đối tượng %>">
                    </asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="cvalCode" ControlToValidate="txtCode" runat="server" ErrorMessage="<%$ Translate: Mã nhóm đối tượng đã tồn tại. %>"
                        ToolTip="<%$ Translate: Mã nhóm đối tượng đã tồn tại. %>">
                    </asp:CustomValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="<%$ Translate: Mã không được chứa ký tự đặc biệt và khoảng trắng %>"
                        ControlToValidate="txtCode" ValidationExpression="^[a-zA-Z0-9_]*$"></asp:RegularExpressionValidator>
                </td>
                <td class="lb">
                    <%# Translate("Tên nhóm đối tượng")%>
                    <span class="lbReq">*</span>
                </td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="reqNamVN" ControlToValidate="txtName" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải nhập Tên nhóm đối tượng %>" ToolTip="<%$ Translate: Bạn phải nhập Tên nhóm đối tượng %>">
                    </asp:RequiredFieldValidator>
        ...
        <tlk:RadGrid PageSize=50  ID="rgMain" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME,REMARK">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã nhóm đối tượng %>" DataField="CODE"
                        UniqueName="CODE" SortExpression="CODE" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Tên nhóm đối tượng %>" DataField="NAME"

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPE_ViewRatingSeniority.ascx.vb"
    Inherits="Performance.ctrlPE_ViewRatingSeniority" %>
...
<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Xếp hạng nhân viên theo thâm niên")%></span>
</div>

        ...
        <tlk:RadSplitter ID="RadSplitter2" runat="server" Width="100%" Height="100%">
            <tlk:RadPane ID="RadPane4" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgCanNotSchedule" runat="server" Height="100%" AllowSorting="false">
                    <MasterTableView DataKeyNames="CRITERIA_ID,CRITERIA_CODE,CRITERIA_NAME" Caption="<%$ Translate: Tiêu chí đánh giá chưa gán nhóm đối tượng %>">
                        <Columns>
            ...
            <tlk:RadPane ID="RadPane3" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgCanSchedule" runat="server" Height="100%" AllowSorting="false"  AllowMultiRowEdit="true">
                    <MasterTableView DataKeyNames="ID" Caption="<%$ Translate: Tiêu chí đánh giá đã gán nhóm đối tượng %>" EditMode="InPlace">
                        <Columns>
                            <tlk:GridClientSelectColumn UniqueName="cbStatus" HeaderStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                            </tlk:GridClientSelectColumn>
                            ...
                            <tlk:GridNumericColumn HeaderText="<%$ Translate: Trọng số %>" DataField="AMONG" UniqueName="AMONG"

    ...
    <script type="text/javascript">
        ...
        function SizeToFit(resize) {
            ...
            window.setTimeout(function () {
                ...
                if (i4 == 0) {
                    radopen('Dialog.aspx?mid=Insurance&fid=ctrlIns_DBInsCeiling&group=Dashboard&width=' + (oWnd1.get_width() - 20) + '&height=' + (oWnd1.get_height() - 80) + "&noscroll=1&resize=" + resize, "rw4");
                    i4 = 1;
                }

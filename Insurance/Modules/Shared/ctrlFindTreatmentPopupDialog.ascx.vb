...
Public Class ctrlFindTreatmentPopupDialog
    Inherits CommonView
...
#Region "Event"
    ...
    Protected Sub rgEmployeeInfo_NeedDataSource(ByVal sender As Object, ByVal e As GridNeedDataSourceEventArgs) Handles rgEmployeeInfo.NeedDataSource
        Try
            ...
            Dim _filter As New INS_WHEREHEALTHDTO
            Dim Sorts As String
            'Dim bShowTerminate As Boolean
            Dim orgID As Decimal? = 0
            Dim TreatmentList As List(Of INS_WHEREHEALTHDTO)
            ...
            If Sorts IsNot Nothing Then
                TreatmentList = rep.GetINS_WHEREHEALTH(_filter, rgEmployeeInfo.CurrentPageIndex, PageSize, MaximumRows, Sorts)
            Else
                TreatmentList = rep.GetINS_WHEREHEALTH(_filter, rgEmployeeInfo.CurrentPageIndex, PageSize, MaximumRows, "EMPLOYEE_CODE asc")
            End If

            rgEmployeeInfo.VirtualItemCount = MaximumRows

            rgEmployeeInfo.DataSource = TreatmentList
        Catch ex As Exception

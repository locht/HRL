...
Partial Public Class ctrlInsChange
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rdFrom As Global.Telerik.Web.UI.RadMonthYearPicker
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rdTo As Global.Telerik.Web.UI.RadMonthYearPicker
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rgInsChange As Global.Telerik.Web.UI.RadGrid

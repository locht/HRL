                    ...
                    <MasterTableView DataKeyNames="ID,ORG_DESC" ClientDataKeyNames="ID">
                        <Columns>
                            ...
                            <tlk:GridCheckBoxColumn UniqueName="IS_ATHOME" DataField="IS_ATHOME" HeaderText="<%$ Translate: Nghỉ tại nhà %>"
                                SortExpression="IS_ATHOME" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                            </tlk:GridCheckBoxColumn>
                            <tlk:GridCheckBoxColumn UniqueName="is_FOCUSED" DataField="is_FOCUSED" HeaderText="<%$ Translate: Nghỉ tập trung %>"
                                SortExpression="is_FOCUSED" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                            </tlk:GridCheckBoxColumn>
...
<tlk:RadScriptBlock ID="scriptBlock" runat="server">
    <script type="text/javascript">
        ...
        function OpenInsertWindow() {
            var oWindow = radopen('Dialog.aspx?mid=Insurance&fid=ctrlInsRemigeManagerNewEdit&group=Business&FormType=0&noscroll=1', "rwPopup");
        ...
        function OpenEditWindow() {
            ...
            if (id > 0) {
                var oWindow = radopen('Dialog.aspx?mid=Insurance&fid=ctrlInsRemigeManagerNewEdit&group=Business&VIEW=TRUE&FormType=0&ID=' + id + '&noscroll=1', "rwPopup");
                oWindow.setSize(800, 480);
                oWindow.center();
            }
        }

    ...
    <tlk:RadPane ID="RadPane2" runat="server">
        ...
        <table class="table-form" onkeydown="return (event.keyCode!=13)">
            ...
            <tr>
                <td colspan="4">
                    <b>
                        <%# Translate("Thông tin hưởng chế độ")%></b>
                    <hr />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="cusRemigeType" runat="server" ErrorMessage="<%$ Translate: Bạn phải chọn loại chế độ. %>"
                        ToolTip="<%$ Translate: Bạn phải chọn loại chế độ. %>" ClientValidationFunction="cusRemigeType">
                    </asp:CustomValidator>

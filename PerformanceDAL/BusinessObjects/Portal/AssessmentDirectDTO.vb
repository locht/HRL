Public Class AssessmentDirectDTO
    ...
    Public Property RESULT_CONVERT_NV As String 'diem danh gia cho tung tieu chi NV
    Public Property CLASSIFICATION_NAME_NV As String 'Xep hang NV

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_DBCourse.ascx.vb"
    Inherits="Training.ctrlTR_DBCourse" %>
...
<div class="box-headchart">
    <span class="headchart"><%# Translate("Thống kê khóa đào tạo thực tế/kế hoạch")%></span>
</div>
...
//                oWnd.setUrl('Dialog.aspx?mid=Training&fid=ctrlTR_DBCourse&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();

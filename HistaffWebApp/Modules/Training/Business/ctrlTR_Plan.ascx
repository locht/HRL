                    ...
                    <MasterTableView DataKeyNames="ID,STATUS_ID" ClientDataKeyNames="ID,STATUS_ID">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Năm %>"  DataField="YEAR"
                                HeaderStyle-Width="60px" SortExpression="YEAR" UniqueName="YEAR" ItemStyle-HorizontalAlign="Center" AllowFiltering="false" />
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenNew() {
            window.open('/Default.aspx?mid=Training&fid=ctrlTR_PlanNewEdit&group=Business', "_self"); /*
            var pos = $("html").offset();
        ...
        function OpenEdit() {
            ...
            window.open('/Default.aspx?mid=Training&fid=ctrlTR_PlanNewEdit&group=Business&ID=' + id, "_self"); /*
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize($(window).width() - 30, $(window).height() - 30); oWindow.center(); */
            return 2;

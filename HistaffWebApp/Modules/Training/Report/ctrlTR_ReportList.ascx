<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlTR_ReportList.ascx.vb"
    Inherits="Training.ctrlTR_ReportList" %>
                    ...
                    <MasterTableView DataKeyNames="ID,CODE,NAME" ClientDataKeyNames="ID">
                        <Columns>
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã báo cáo %>" DataField="CODE" UniqueName="CODE"
                                SortExpression="CODE" HeaderStyle-Width="40%" />
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Tên báo cáo %>" DataField="NAME"
                                UniqueName="NAME" SortExpression="NAME" HeaderStyle-Width="60%" />
                        </Columns>
                    </MasterTableView>

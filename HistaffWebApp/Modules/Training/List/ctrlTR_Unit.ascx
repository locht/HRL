...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="250px">
        ...
        <table class="table-form">
            ...
            <tr>
                ...
                <td colspan="6">
                    <tlk:RadTextBox ID="txtAddress" MaxLength="255" runat="server" Width="100%">
                    </tlk:RadTextBox>
                </td>
            </tr>
            <tr>
        ...
        <tlk:RadGrid ID="rgMain" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME,ADDRESS,PHONE,FAX,WEB,TAX_CODE,TRAIN_FIELD,REPRESENT,CONTACT_PERSON,CONTACT_PHONE,CONTACT_EMAIL,REMARK,DESC_U">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã đơn vị %>" DataField="CODE" UniqueName="CODE"
                        SortExpression="CODE"  HeaderStyle-Width="100px"/>
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Tên đơn vị %>" DataField="NAME" UniqueName="NAME"
                        SortExpression="NAME" HeaderStyle-Width="200px" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Địa chỉ %>" DataField="ADDRESS" UniqueName="ADDRESS"
                        SortExpression="ADDRESS" HeaderStyle-Width="250px" />
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Fax %>" DataField="FAX" UniqueName="FAX"
                        SortExpression="FAX" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Web %>" DataField="WEB" UniqueName="WEB"
                        SortExpression="WEB" />
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Lĩnh vực đào tạo %>" DataField="TRAIN_FIELD"
                        UniqueName="TRAIN_FIELD" SortExpression="TRAIN_FIELD" HeaderStyle-Width="200px" />
                    ...
                    <tlk:GridCheckBoxColumn HeaderText="<%$ Translate: Trạng thái %>" DataField="ACTFLG"
                        UniqueName="ACTFLG" SortExpression="ACTFLG" ShowFilterIcon="true"  HeaderStyle-Width="90px"/>
                </Columns>

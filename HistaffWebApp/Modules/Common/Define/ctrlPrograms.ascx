...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Height="100%" Orientation="Horizontal">
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid ID="rgPrograms" runat="server" AllowPaging="True" AllowSorting="True" SkinID="GridSingleSelect"
            ...
            PageSize="50" Height="100%" AllowFilteringByColumn="true" AutoGenerateColumns="false" OnPreRender="rgPrograms_PreRender">
        ...
        function OnClientButtonClicking(sender, args) {
            ...
            if (args.get_item().get_commandName() == 'SAVE') {
                ...
                if (!Page_ClientValidate("")) {
                    ResizeSplitter(splitterID, pane1ID, pane2ID, validateID, oldSize, 'rgPrograms', 0 , 0, 17);
                }
                else {
                    ResizeSplitterDefault(splitterID, pane1ID, pane2ID, oldSize);
                }

...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Scrolling="None" Height="250px">
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustomValidatorCode" ControlToValidate="rtbProgramCode"
                        runat="server" ErrorMessage="<%$ Translate: CM_CTRLPROGRAMS_PROGRAM_CODE_ERROR_EXIST %>"
                        ToolTip="<%$ Translate: CM_CTRLPROGRAMS_PROGRAM_CODE_ERROR_EXIST %>">
                    </asp:CustomValidator>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustomValidatorName" ControlToValidate="rtbProgramName"
                        runat="server" ErrorMessage="<%$ Translate: CM_CTRLPROGRAMS_PROGRAM_NAME_ERROR_EXIST %>"
                        ToolTip="<%$ Translate: CM_CTRLPROGRAMS_PROGRAM_NAME_ERROR_EXIST %>"></asp:CustomValidator>
                </td>
                <td class="lb">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="RadNTBPriority"
                        ...
                        ToolTip="<%$ Translate: CM_CTRLPROGRAMS_PRIORITY_ERROR_EXIST %>">
                    </asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="lb" style="padding-left: 40px">
                    <%# Translate("TEMPLATE_TYPE_OUT")%>&nbsp;<span class="lbReq">*</span>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <tlk:RadTextBox ID="rtbFileOutName" runat="server" Width="100%" MaxLength="100" ToolTip="<%$ Translate: CM_CTRLPROGRAMS_FILE_OUT_NAME %>"
                        Height="22" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFileOutName" ControlToValidate="rtbStoreOut"
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid ID="rgPrograms" runat="server" AllowPaging="True" AllowSorting="True"
            CellSpacing="0" ShowStatusBar="true" AllowMultiRowSelection="true" GridLines="None"
            PageSize="50" Height="99%" AllowFilteringByColumn="true" AutoGenerateColumns="false">
    ...
    <script type="text/javascript">
        ...
        function OnClientButtonClicking(sender, args) {
            ...
            if (item.get_commandName() == "CANCEL") {
                window.location.replace('/Default.aspx?mid=Common&fid=ctrlPrograms&group=Secure');
                args.set_cancel(true);
            }
        }
        ...
        function gridRowDblClick(sender, eventArgs) {
            ...
            window.open('/Default.aspx?mid=Common&fid=ctrlProGramParameters&group=Secure&programCode=' + programCode, "_self"); /*
            var pos = $("html").offset();

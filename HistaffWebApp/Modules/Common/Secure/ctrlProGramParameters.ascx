...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Height="100%" Width="100%" Orientation="Horizontal">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustomValidatorParaName" runat="server" ControlToValidate="rtbParameterName"
                        Display="Dynamic" ErrorMessage="<%$ Translate: CM_CTRLPROGRAMPARAMETERS_PROGRAM_CODE_ERROR_EXIST %>" ToolTip="<%$ Translate: CM_CTRLPROGRAMPARAMETERS_PARAMETER_NAME_ERROR_EXIST %>"></asp:CustomValidator>
                </td>                        
                <td class="lb" style="padding-right: 10px">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustomValidatorSequence" ControlToValidate="RadNTBSequence"
                        runat="server" ErrorMessage="<%$ Translate: CM_CTRLPROGRAMPARAMETERS_SEQUENCE_ERROR_EXIST %>" ToolTip="<%$ Translate: CM_CTRLPROGRAMPARAMETERS_SEQUENCE_ERROR_EXIST %>"
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="Y">
        <tlk:RadGrid ID="rgProgramParameters" runat="server" AllowFilteringByColumn="true"

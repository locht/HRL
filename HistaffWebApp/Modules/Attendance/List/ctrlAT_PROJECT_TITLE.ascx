<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlAT_PROJECT_TITLE.ascx.vb"
    Inherits="Attendance.ctrlAT_PROJECT_TITLE" %>
...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="120px" Scrolling="None">
        ...
        <table class="table-form">
            <tr>
                <td class="lb">
                    <%# Translate("Mã chức danh")%><span class="lbReq">*</span>
                </td>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtCode"
                        runat="server" Text="*" ErrorMessage="<%$ Translate: Bạn phải nhập mã chức danh %>"></asp:RequiredFieldValidator>
                ...
                <td class="lb">
                    <%# Translate("Tên chức danh")%><span class="lbReq">*</span>
                </td>
                <td>
                    <tlk:RadTextBox ID="txtName" runat="server">
                    </tlk:RadTextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtName"
                        runat="server" Text="*" ErrorMessage="<%$ Translate: Bạn phải nhập tên chức danh %>"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="lb">
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid PageSize="50" ID="rgDanhMuc" runat="server" AutoGenerateColumns="False"
            AllowPaging="True" Height="100%" AllowSorting="True" AllowMultiRowSelection="true" OnPreRender="rgDanhMuc_PreRender">
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME,REMARK">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã chức danh %>" DataField="CODE"
                        UniqueName="CODE" SortExpression="CODE" HeaderStyle-Width="25%"/>
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Tên chức danh %>" DataField="NAME"
                        UniqueName="NAME" SortExpression="NAME" HeaderStyle-Width="35%"/>
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mô tả %>" DataField="REMARK" UniqueName="REMARK"
                        SortExpression="REMARK"  HeaderStyle-Width="40%"/>
                </Columns>
            </MasterTableView>
        </tlk:RadGrid>
    </tlk:RadPane>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlAT_PROJECT_TITLE_RadPane1';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlAT_PROJECT_TITLE_RadPane2';
        var validateID = 'MainContent_ctrlAT_PROJECT_TITLE_valSum';

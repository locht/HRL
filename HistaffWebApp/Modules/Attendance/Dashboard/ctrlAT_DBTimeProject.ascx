<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlAT_DBTimeProject.ascx.vb"
    Inherits="Attendance.ctrlAT_DBTimeProject" %>
...
<%--<div class="box-headchart">
    <span class="headchart"><%# Translate("Công theo dự án (ngày công)")%></span>
</div>--%>
...
//                oWnd.setUrl('Dialog.aspx?mid=Attendance&fid=ctrlAT_DBTimeProject&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();
     ...
     function InIEvent() {
        $(function () {
            ...
            $('#container').highcharts({
                ...
                series: [<%=data %>],                    
                            title: {
                               text:'<span style="font-weight: bold;color: #767676;font-size:12px;">Công theo dự án(ngày công)</span>'
                            }       
            });
        });
    }

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlAT_DBTimeOff.ascx.vb"
    Inherits="Attendance.ctrlAT_DBTimeOff" %>
...
<%--<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Thống kê nghỉ phép, nghỉ bù/Tổng công nghỉ (ngày công)")%></span>
</div>--%>
...
//                oWnd.setUrl('Dialog.aspx?mid=Attendance&fid=ctrlAT_DBTimeOff&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();
        ...
        $(function () {
            ...
            $('#container').highcharts({
             credits: {
                ...
                title: {
                            text:'<span style="font-weight: bold;color: #767676;font-size:12px;">Thống kê nghỉ phép, nghỉ bù/Tổng công nghỉ (ngày công)</span>'
                        }
            });
        });
    }

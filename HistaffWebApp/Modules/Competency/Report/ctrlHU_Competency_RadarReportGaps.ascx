<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_Competency_RadarReportGaps.ascx.vb"
    Inherits="Profile.ctrlHU_Competency_RadarReportGaps" %>
    ...
    <tlk:RadPane ID="RadPane1" runat="server" Height="85px" Scrolling="None">
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    <tlk:RadComboBox ID="cboYear1" SkinID="dDropdownList" runat="server" AutoPostBack="true"
                        CausesValidation="false">
                    </tlk:RadComboBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <tlk:RadComboBox ID="cboCompetencyPeriod1" SkinID="dDropdownList" runat="server">
                    </tlk:RadComboBox>
                </td>
                <td>
                    <tlk:RadButton ID="btnSearch" runat="server" SkinID="ButtonFind" CausesValidation="false"
                        Text="<%$ Translate: Tìm %>" OnClientClicked="OnClientClicked">

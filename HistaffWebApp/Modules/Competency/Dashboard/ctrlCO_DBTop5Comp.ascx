<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlCO_DBTop5Comp.ascx.vb"
    Inherits="Profile.ctrlCO_DBTop5Comp" %>
...
<div class="box-headchart">
    <span class="headchart"><%# Translate("Top 5 năng lực được yêu cầu để đào tạo")%></span>
</div>
...
//                oWnd.setUrl('Dialog.aspx?mid=Profile&fid=ctrlCO_DBTop5Comp&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();

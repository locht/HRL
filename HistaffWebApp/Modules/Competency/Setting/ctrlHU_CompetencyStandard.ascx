    ...
    <tlk:RadPane ID="RadPane1" runat="server" Height="120px" Scrolling="None">
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    <tlk:RadComboBox ID="cboCompetencyGroup" runat="server" AutoPostBack="true" CausesValidation="false" Width="250px">
                    </tlk:RadComboBox>
            ...
            <tr>
                ...
                <td>
                    <tlk:RadComboBox ID="cboCompetency" runat="server" Width="250px">
                    </tlk:RadComboBox>
                ...
                <td>
                    <tlk:RadComboBox ID="cboLevelNumber" runat="server" Width="250px">
                        <Items>

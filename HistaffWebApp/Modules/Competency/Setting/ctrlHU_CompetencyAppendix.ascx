    ...
    <tlk:RadPane ID="RadPane1" runat="server" Height="140px" Scrolling="None">
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    <tlk:RadComboBox ID="cboTitle" runat="server" Width="400px">
                    </tlk:RadComboBox>
...
//            window.open('/Default.aspx?mid=Competency&fid=ctrlHU_CompetencyStandard&group=Setting', "_self"); 
            var oWindow = radopen(value, "rwPopup");
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize($(window).width() - 500, $(window).height() - 200); oWindow.center(); 
            oWindow.center();
            return false;
        }

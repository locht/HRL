    ...
    <tlk:RadPane ID="RadPane1" runat="server" Height="100%" Scrolling="Both">
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    <tlk:RadComboBox ID="cboSalaryLevel" runat="server" SkinID="LoadDemand" AutoPostBack="True" CausesValidation="False" OnClientSelectedIndexChanged="OnClientSelectedIndexChanged"
                        >
                    </tlk:RadComboBox>
            ...
            <tr>
                <td class="item-head" colspan="6">
                        <%# Translate("Thiết lập định mức thưởng chi tiết")%>
                    <hr />
                </td>
            </tr>
            <tr>

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPA_DBSalaryIncome.ascx.vb"
    Inherits="Payroll.ctrlPA_DBSalaryIncome" %>
...
<%--<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Thống kê tổng thu nhập nhân viên theo các khoảng lương")%></span>
</div>--%>
...
//                oWnd.setUrl('Dialog.aspx?mid=Payroll&fid=ctrlPA_DBSalaryRange&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();
        ...
        $(function () {
            ...
            $('#container').highcharts({
             credits: {
                ...
                title: {
                            text:'<span style="font-weight: bold;color: #767676;font-size:12px;"><%# Translate("Thống kê tổng thu nhập nhân viên theo các khoảng lương")%></span>'
                        }                
            });
        });
    }

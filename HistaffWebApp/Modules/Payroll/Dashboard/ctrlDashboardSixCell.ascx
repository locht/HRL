    ...
    <script type="text/javascript">
        ...
        function SizeToFit(resize) {
            ...
            window.setTimeout(function () {
                ...
                if (i3 == 0) {
                    radopen('Dialog.aspx?mid=Payroll&fid=ctrlPA_DBSalaryAverage&group=Dashboard&width=' + (oWnd1.get_width() - 20) + '&height=' + (oWnd1.get_height() - 30) + "&noscroll=1&resize=" + resize, "rw3");
                    i3 = 1;
                }
                ...
                if (i4 == 0) {
                    radopen('Dialog.aspx?mid=Payroll&fid=ctrlPA_DBSalaryIncome&group=Dashboard&width=' + (oWnd1.get_width()) + '&height=' + (oWnd1.get_height() - 30) + "&noscroll=1&resize=" + resize, "rw4");
                    i4 = 1;
                }
                ...
                if (i5 == 0) {
                    radopen('Dialog.aspx?mid=Payroll&fid=ctrlPA_DBSalaryIncome&group=Dashboard&width=' + (oWnd1.get_width()) + '&height=' + (oWnd1.get_height() - 30) + "&noscroll=1&resize=" + resize, "rw5");
                    i5 = 1;
                }
                ...
                if (i6 == 0) {
                    radopen('Dialog.aspx?mid=Payroll&fid=ctrlPA_DBSalaryIncome&group=Dashboard&width=' + (oWnd1.get_width() - 20) + '&height=' + (oWnd1.get_height() - 30) + "&noscroll=1&resize=" + resize, "rw6");
                    i6 = 1;
                }

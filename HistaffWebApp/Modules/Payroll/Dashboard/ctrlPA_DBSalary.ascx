<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPA_DBSalary.ascx.vb"
    Inherits="Payroll.ctrlPA_DBSalary" %>
        ...
        $(function () {
            ...
            $('#container').highcharts({
             credits: {
                ...
                title: {
                            text:'<span style="font-weight: bold;color: #767676;font-size:12px;"><%# Translate("Thống kê lương (triệu đồng)")%></span>'
                        }
            });
        });
    }

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPA_SaleCommision.ascx.vb"
    Inherits="Payroll.ctrlPA_SaleCommision" %>
        ...
        <table class="table-form">
            <tr>
             ...
             <tr>
                ...
                <td class="lb">
                    <%# Translate("Tỷ lệ Sale")%><span class="lbReq">*</span>
                </td>
                <td>
               <%-- <tlk:RadTextBox ID="txtSaleRate" runat="server"  >
                    </tlk:RadTextBox>--%>
                       <tlk:RadNumericTextBox runat="server" ID="rtxtSaleRate"  Width="160px"
                     >
                     ...
                     <asp:RequiredFieldValidator ID="ReqSale" ControlToValidate="rtxtSaleRate" runat="server"
                        ErrorMessage="<%$ Translate: Bạn phải nhập tỷ lệ . %>" ToolTip="<%$ Translate: Bạn phải nhập tỷ lệ %>">
                    </asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid ID="rgData" runat="server" Height="100%">
          <ClientSettings EnableRowHoverStyle="true">
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME,REMARK,SALE_RATE,ORDERS">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Tỷ lệ Sale %>" DataField="SALE_RATE"
                        SortExpression="SALE_RATE" UniqueName="SALE_RATE" DataFormatString="{0:n1}" /> 

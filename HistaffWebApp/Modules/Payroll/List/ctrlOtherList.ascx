    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            <tlk:RadPane ID="RadPane1" runat="server" Height="120px" Scrolling="None">
                ...
                <table class="table-form">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="<%$ Translate: Mã không được chứa ký tự đặc biệt và khoảng trắng %>"
                                ...
                                <asp:RequiredFieldValidator ID="reqOtherCode" ControlToValidate="txtCode"
                                runat="server" Text="*" ErrorMessage="<%$ Translate: Bạn phải nhập mã tham số %>"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <tlk:RadTextBox ID="txtRemark" SkinID="Textbox1023" Width="100%" runat="server" Height="40px">
                            </tlk:RadTextBox>
                        </td>
                    </tr>
                </table>
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid ID="rgOtherList" runat="server" Height="100%" PageSize="50" OnPreRender="rgOtherList_PreRender">
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        var splitterID = 'ctl00_MainContent_ctrlOtherList_RadSplitter1';
        ...
        function OnClientButtonClicking(sender, args) {
            ...
            if (item.get_commandName() == "EXPORT") {
                var rows = $find('<%= rgOtherList.ClientID %>').get_masterTableView().get_dataItems().length;
                if (rows == 0) {
                ...
                ResizeSplitterDefault(splitterID, pane1ID, pane2ID, oldSize);
                var bCheck = $find('<%= rgOtherList.ClientID %>').get_masterTableView().get_selectedItems().length;
                if (bCheck > 1) {

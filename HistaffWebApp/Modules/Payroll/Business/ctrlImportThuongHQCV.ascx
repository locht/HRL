<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlImportThuongHQCV.ascx.vb"
    Inherits="Payroll.ctrlImportThuongHQCV" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        registerOnfocusOut('RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlImportThuongHQCV_MainPane');
    });

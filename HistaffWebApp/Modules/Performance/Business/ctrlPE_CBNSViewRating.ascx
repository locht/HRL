    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="center" valign="middle">
                            <tlk:RadButton ID="btnSearch" runat="server" SkinID="ButtonFind" CausesValidation="false"
                                AutoPostBack="true" Text="<%$ Translate: Tìm %>" OnClientClicked="OnClientClicked">
                            </tlk:RadButton>
                        </td>
                    </tr>
                </table>
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <div id="container" style="min-width: 310px; padding-top: 20px; height: 400px; margin: 0 auto">
                </div>
            </tlk:RadPane>
        </tlk:RadSplitter>
    </tlk:RadPane>

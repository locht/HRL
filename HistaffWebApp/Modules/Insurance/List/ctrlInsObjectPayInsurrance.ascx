...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%">
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            <tlk:RadPane ID="RadPane1" runat="server" Height="100%" Width="100%" Scrolling="none">
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            <tlk:RadListBox rendermode="Lightweight" ID="radLstInsurrance" runat="server" CheckBoxes="false"
                                showcheckall="false" Width="400px" Height="400px" AutoPostBack="true">
                                <Items>
                        ...
                        <td style="vertical-align: top">
                            <tlk:RadListBox rendermode="Lightweight" ID="radLstContact" runat="server" CheckBoxes="true"
                                showcheckall="true" Width="400px" Height="400px">
                            </tlk:RadListBox>
                        </td>
                    </tr>
                </table>

...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%">
    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None" Height="75px">
            ...
            <tlk:RadPane ID="RadPane1" runat="server" Scrolling="None" Height="100%" Width="100%">
                <tlk:RadGrid PageSize="50" ID="rgAgrising" runat="server" Height="100%" AllowSorting="True"
                    ...
                    <MasterTableView DataKeyNames="ID,EMPLOYEE_ID">
                        <Columns>
                            ...
                            <tlk:GridCheckBoxColumn HeaderText="<%$ Translate: BHYT %>" DataField="ISBHYT" ItemStyle-HorizontalAlign="Center"
                                UniqueName="ISBHYT" HeaderStyle-HorizontalAlign="Center" AllowFiltering="false">
                                <HeaderStyle HorizontalAlign="Center" />
                            </tlk:GridCheckBoxColumn>
...
<tlk:RadScriptBlock ID="scriptBlock" runat="server">
    <script type="text/javascript">
        ...
        var splitterID = 'ctl00_MainContent_ctrlInsClosedNew_RadSplitter1';
        var pane1ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlInsClosedNew_RadPane2';
        var pane2ID = 'RAD_SPLITTER_PANE_CONTENT_ctl00_MainContent_ctrlInsClosedNew_RadPane1';
        ...
        function GridCreated(sender, eventArgs) {
            ...
            ResizeSplitter(splitterID, pane1ID, pane2ID, '', oldSize, 'rgAgrising');
        }
        ...
        function OnClientButtonClicking(sender, args) {
            if (args.get_item().get_commandName() == 'EXPORT') {
                var rows = $find('<%= rgAgrising.ClientID %>').get_masterTableView().get_dataItems().length;
                if (rows == 0) {

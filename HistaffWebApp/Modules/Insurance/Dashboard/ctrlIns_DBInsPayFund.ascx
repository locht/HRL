<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlIns_DBInsPayFund.ascx.vb"
    Inherits="Insurance.ctrlIns_DBInsPayFund" %>
...
<%--<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Quỹ lương bảo hiểm (triệu đồng)")%></span>
</div>--%>
    ...
    function MaxClick(sender, e) {
        ...
        switch (btnText) {
            case "Maximize":
                ...
                oWnd.setUrl('Dialog.aspx?mid=Insurance&fid=ctrlIns_DBInsPayFund&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
                break;
            case "Restore":
                oWnd.restore();
        ...
        $(function () {
            ...
            $('#container').highcharts({
             credits: {
                ...
                title: {
                            text:'<span style="font-weight: bold;color: #767676;font-size:12px;">Quỹ lương bảo hiểm (triệu đồng)</span>'
                        }
            });
        });
    }

...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%" Orientation="Horizontal"
    ...
    <tlk:RadPane ID="RadPane1" runat="server" Scrolling="None">
        <tlk:RadGrid AllowPaging="false" ID="rgGridDataRate" runat="server" Height="100%" >
            <MasterTableView DataKeyNames="TYPE_NAME" ClientDataKeyNames="TYPE_NAME">
                <Columns>
                    ...
                    <tlk:GridNumericColumn HeaderText="<%$ Translate: Công ty đóng %>" DataFormatString="{0:N1} %"
                        DataField="COMPANY_RATE" UniqueName="COMPANY_RATE" SortExpression="COMPANY_RATE">
                        <ItemStyle HorizontalAlign="right" VerticalAlign="Middle" />
                    </tlk:GridNumericColumn>
                    <tlk:GridNumericColumn HeaderText="<%$ Translate: Nhân viên đóng %>" DataFormatString="{0:N1} %"
                        DataField="EMPLOYEE_RATE" UniqueName="EMPLOYEE_RATE" SortExpression="EMPLOYEE_RATE">
                        <ItemStyle HorizontalAlign="right" VerticalAlign="Middle" />
                    </tlk:GridNumericColumn>
                    <tlk:GridNumericColumn HeaderText="<%$ Translate: Tổng cộng %>" DataFormatString="{0:N1} %"

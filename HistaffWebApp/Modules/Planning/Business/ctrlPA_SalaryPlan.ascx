                ...
                <table class="table-form" onkeydown="return (event.keyCode!=13)">
                    <tr>
                        ...
                        <td>
                            ...
                            <tlk:RadNumericTextBox ID="rntxtYear" runat="server" NumberFormat-DecimalDigits="1"
                    ...
                    <MasterTableView DataKeyNames="ID,ORG_DESC" ClientDataKeyNames="ID">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Bộ phận %>" DataField="ORG_NAME"
                                SortExpression="ORG_NAME" UniqueName="ORG_NAME" HeaderStyle-Width="30%">
                            </tlk:GridBoundColumn>
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Chức danh %>" DataField="TITLE_NAME"
                                SortExpression="TITLE_NAME" UniqueName="TITLE_NAME" HeaderStyle-Width="30%">
                            </tlk:GridBoundColumn>
                            <tlk:GridNumericColumn HeaderText="<%$ Translate: Nhân viên hiện tại %>" DataField="EMP_CUR"
                                SortExpression="EMP_CUR" UniqueName="EMP_CUR" HeaderStyle-Width="10%" />
                            <tlk:GridNumericColumn HeaderText="<%$ Translate: Định biên nhân sự %>" DataField="EMP_NUMBER"
                                SortExpression="EMP_NUMBER" UniqueName="EMP_NUMBER" HeaderStyle-Width="10%" />
                            <tlk:GridNumericColumn HeaderText="<%$ Translate: Quỹ lương theo định biên %>" DataField="TOTAL"
                                SortExpression="TOTAL" UniqueName="TOTAL" DataFormatString="{0:n0}" HeaderStyle-Width="20%" />
                        </Columns>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenNew() {
            ...
            window.open('/Default.aspx?mid=Payroll&fid=ctrlPA_SalaryPlanNewEdit&group=Setting&year=' + year + '&org_id=' + org + '&Org_Name=' + orgName, "_self"); /*
            var pos = $("html").offset();
        ...
        function OpenEdit() {
            ...
            window.open('/Default.aspx?mid=Payroll&fid=ctrlPA_SalaryPlanNewEdit&group=Setting&ID=' + id, "_self"); /*
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize(800, 400);
            oWindow.center(); */

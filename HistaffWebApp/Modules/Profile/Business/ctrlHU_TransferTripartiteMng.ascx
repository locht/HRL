    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize="50" ID="rgWorking" runat="server" SkinID="GridSingleSelect"
                    Height="100%">
                    ...
                    <MasterTableView DataKeyNames="ID,STATUS_ID,EMPLOYEE_3B_ID,DECISION_TYPE_ID,EMPLOYEE_CODE"
                        ...
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Đơn vị chuyển đi %>" DataField="ORG_MOVE_NAME"
                                SortExpression="ORG_MOVE_NAME" UniqueName="ORG_MOVE_NAME" />
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Đơn vị chuyển đến %>" DataField="ORG_NAME"
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function GridCreated(sender, eventArgs) {
            registerOnfocusOut('RAD_SPLITTER_ctl00_MainContent_ctrlHU_TransferTripartiteMng_RadSplitter3');
        }
        ...
        function OpenNew() {
            ...
            window.open('/Default.aspx?mid=Profile&fid=ctrlHU_TransferTripartiteNewEdit&group=Business' + extented + '&parentID=Transfer', "_self"); /*
        ...
        function OpenEdit(e) {
            ...
            window.open('/Default.aspx?mid=Profile&fid=ctrlHU_TransferTripartiteNewEdit&group=Business&ID=' + id + '&parentID=Transfer', "_self"); /*
            oWindow.setSize(1020, $(window).height());
            oWindow.center(); */
            return 0;
        }

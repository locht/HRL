<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_ALP.ascx.vb"
    Inherits="Profile.ctrlHU_ALP" %>
                        ...
                        <Columns>
                          <%--<tlk:GridClientSelectColumn UniqueName="cbStatus" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <tlk:GridTemplateColumn HeaderText="Phòng ban" DataField="ORG_NAME" SortExpression="ORG_NAME"
                                UniqueName="ORG_NAME" HeaderStyle-Width="100px">
                            </tlk:GridTemplateColumn>
                            <tlk:GridBoundColumn HeaderText="Chức danh" DataField="TITLE_NAME" SortExpression="TITLE_NAME"
                                UniqueName="TITLE_NAME" HeaderStyle-Width="100px" />
                            <tlk:GridBoundColumn HeaderText="Năm" DataField="WORK_STATUS" SortExpression="WORK_STATUS" UniqueName="WORK_STATUS"  />
                            <tlk:GridDateTimeColumn HeaderText="Từ ngày" DataField="START_DATE" ItemStyle-HorizontalAlign="Center"
                                SortExpression="START_DATE" UniqueName="START_DATE" DataFormatString="{0:dd/MM/yyyy}">
                            </tlk:GridDateTimeColumn>
                            <tlk:GridBoundColumn HeaderText="Đến ngày" DataField="EXPIRE_DATE" SortExpression="EXPIRE_DATE"
                                UniqueName="EXPIRE_DATE" DataFormatString="{0:dd/MM/yyyy}" />
                            <tlk:GridBoundColumn HeaderText="Số ngày" DataField="DAY_NUMBER" SortExpression="DAY_NUMBER"
                                UniqueName="DAY_NUMBER" />                            

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlHU_TranningEvaluate.ascx.vb"
    Inherits="Profile.ctrlHU_TranningEvaluate" %>
            ...
            <tlk:RadPane ID="RadPane1" runat="server" Height="38px" Scrolling="None">
                <table class="table-form">
                    <tr>
                        ...
                        <td>
                            <tlk:RadTextBox ID="txtYear" runat="server">
                            </tlk:RadTextBox>
                        </td>
                        <td class="lb">
                        <asp:Label ID="lbEvaluate" runat="server" Text="Kì đánh giá"></asp:Label>
                        </td>
                        <td>
                            <tlk:RadComboBox ID="cbEvaluate" runat="server">
                            </tlk:RadComboBox>
                        </td>
                        <td>
                        ...
                        <Columns>
                           <%-- <tlk:GridClientSelectColumn UniqueName="cbStatus" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <tlk:GridBoundColumn HeaderText="Chức danh" DataField="TITLE_NAME"
                                ...
                                SortExpression="CAPACITY_NAME" UniqueName="CAPACITY_NAME" />
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenNew() {
            ...
            window.open('/Default.aspx?mid=Profile&fid=ctrlHU_TrainingEvaluateNewEdit&group=Business' + extented, "_self");
        }
        ...
        function OpenEditContract() {
            ...
            window.open('/Default.aspx?mid=Profile&fid=ctrlHU_TrainingEvaluateNewEdit&group=Business&IDSelect=' + id + '&empid=' + emp_id, "_self"); /*

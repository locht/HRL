<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDashboardSixCellSixCell.ascx.vb"
    Inherits="Profile.ctrlDashboardSixCell" %>
    ...
    <script type="text/javascript">
        ...
        function SizeToFit(resize) {
            ...
            window.setTimeout(function () {
                ...
                if (i4 == 0) {
                    radopen('Dialog.aspx?mid=Profile&fid=ctrlDBSeniority&group=Dashboard&width=' + (oWnd1.get_width() - 20) + '&height=' + (oWnd1.get_height() - 80) + "&noscroll=1&resize=" + resize, "rw4");
                    i4 = 1;
                }
                ...
                if (i5 == 0) {
                    radopen('Dialog.aspx?mid=Profile&fid=ctrlDBSeniority&group=Dashboard&width=' + (oWnd1.get_width() - 20) + '&height=' + (oWnd1.get_height() - 80) + "&noscroll=1&resize=" + resize, "rw5");
                    i5 = 1;
                }
                ...
                if (i6 == 0) {
                    radopen('Dialog.aspx?mid=Profile&fid=ctrlDBInfoProfile&group=Dashboard&width=' + (oWnd1.get_width() - 20) + '&height=' + (oWnd1.get_height() - 80) + "&noscroll=1&resize=" + resize, "rw6");
                    i6 = 1;
                }

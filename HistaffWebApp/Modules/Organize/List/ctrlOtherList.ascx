    ...
    <tlk:RadPane ID="MainPane" runat="server" Scrolling="None">
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            <tlk:RadPane ID="RadPane1" runat="server" Height="115px" Scrolling="None">
                ...
                <table class="table-form">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <tlk:RadTextBox ID="txtRemark" SkinID="Textbox1023" Width="100%" Height="40px" runat="server">
                            </tlk:RadTextBox>
                        </td>
                    </tr>
                </table>
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                <tlk:RadGrid PageSize=50 ID="rgOtherList" runat="server" Height="100%" AllowMultiRowSelection="true">

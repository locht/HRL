...
<style>
    ...
    #ctl00_MainContent_ctrlHU_ChartEmployee_rcEmployee div ul li ul li div.rocItem div.rocItemTemplate
    {
        margin-left:2px;
        height: 100px;
    }

    #ctl00_MainContent_ctrlHU_ChartEmployee_rcEmployee div ul li div.rocItem a.rocExpandArrow
    {
        margin-left: 20px;
    }
        ...
        <tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
            ...
            <tlk:RadPane ID="RadPane2" runat="server" Scrolling="Both">
                <tlk:RadOrgChart rendermode="Lightweight" ID="rcEmployee" runat="server" Skin="Metro" DisableDefaultImage="false"
                    EnableDrillDown="true" EnableGroupCollapsing="true" EnableCollapsing="true" DataFieldID="TITLE_ID"
                    DataFieldParentID="PARENT_ID" DataTextField="FULLNAME_VN">
                    <ItemTemplate>

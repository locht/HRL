<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRC_DBCanToEmp.ascx.vb"
    Inherits="Recruitment.ctrlRC_DBCanToEmp" %>
...
<div class="box-headchart">
    <span class="headchart"><%# Translate("Tỷ lệ chuyển đổi từ hồ sơ ứng viên thành nhân viên")%></span>
</div>

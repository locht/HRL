<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRC_CadidateReference.ascx.vb"
    Inherits="Recruitment.ctrlRC_CadidateReference" %>
...
<tlk:RadSplitter ID="RadSplitter2" runat="server" Orientation="Horizontal" Style="height: 100%;
    ...
    <tlk:RadPane ID="RadPane3" runat="server" Scrolling="None" Height="100%">
        <tlk:RadGrid ID="rgReference" runat="server" AllowMultiRowSelection="true" Height="100%" AllowPaging="true" PageSize="50">

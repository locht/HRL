        ...
        <tlk:RadGrid ID="rgSingleTranning" runat="server" AllowMultiRowSelection="true" Height="100%">
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="SCHOOL_NAME,BRANCH_NAME,LEVEL,CERTIFICATE,CONTENT,TRAINNING,FROMDATE,TODATE,RANK,YEAR_GRADUATE,COST,REMARK">
                ...
                <Columns>
                    ...
                    <tlk:GridDateTimeColumn DataField="FROMDATE" HeaderText="<%$ Translate: Từ ngày%>"
                        DataFormatString="{0:dd/MM/yyyy}" UniqueName="FROMDATE">
                    </tlk:GridDateTimeColumn>
                    <tlk:GridDateTimeColumn DataField="TODATE" HeaderText="<%$ Translate: Đến ngày%>"
                    ...
                    <tlk:GridNumericColumn DataField="COST" HeaderText="<%$ Translate: Chi phí%>" UniqueName="COST"

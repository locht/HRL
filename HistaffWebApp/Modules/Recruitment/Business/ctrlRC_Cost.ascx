            ...
            <tlk:RadPane ID="RadPane3" runat="server" Height="250px" Scrolling="None">
                <table  class="table-form">
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <asp:CustomValidator ID="cvalCode" ControlToValidate="cboProgramName" runat="server"
                                ErrorMessage="<%$ Translate: Vị trí tuyển dụng đã tồn tại %>" ToolTip="<%$ Translate: Vị trí tuyển dụng đã tồn tại %>">
                            </asp:CustomValidator>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <tlk:RadNumericTextBox ID="rntxtCostActual" runat="server" SkinID="Money" ReadOnly="true">
                            </tlk:RadNumericTextBox>
                        </td>
                    </tr>
                    <tr>

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRC_ImageUpload.ascx.vb"
    Inherits="Recruitment.ctrlRC_ImageUpload" %>
<style type="text/css">
    #btnSaveImage
    {
        display: none;
...
<div class="box_image">
    <div class="image_frame">
        <tlk:RadBinaryImage ID="rbiCandidateImage" runat="server" AutoAdjustImageControlSize="true"
            Width="90px" Height="120px" ResizeMode="Fill" />
        <asp:HiddenField runat="server" ID="hidCandidateID" />
    </div>

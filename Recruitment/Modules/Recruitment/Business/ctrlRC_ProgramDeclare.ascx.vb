...
Public Class ctrlRC_ProgramDeclare
    Inherits CommonView
...
#Region "Page"
    ...
    Public Overrides Sub ViewInit(e As System.EventArgs)
        ...
        Try
            Dim startTime As DateTime = DateTime.UtcNow
            ViewItem1 = Me.Register("ctrlRC_ProgramExams", "Recruitment", "ctrlRC_ProgramExams", "Business")
            ViewItem2 = Me.Register("ctrlRC_ProgramSchedule", "Recruitment", "ctrlRC_ProgramSchedule", "Business")
            ViewItem3 = Me.Register("ctrlRC_ProgramUpdateResult", "Recruitment", "ctrlRC_ProgramUpdateResult", "Business")
            _myLog.WriteLog(_myLog._info, _classPath, method,
                          CLng(DateTime.UtcNow.Subtract(startTime).TotalSeconds).ToString(), Nothing, "")
        Catch ex As Exception
            _myLog.WriteLog(_myLog._error, _classPath, method, 0, ex, "")

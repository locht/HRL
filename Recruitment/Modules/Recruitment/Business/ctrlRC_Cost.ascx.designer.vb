...
Partial Public Class ctrlRC_Cost
    ...
    '''<summary>
    '''cboProgramName control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents cboProgramName As Global.Telerik.Web.UI.RadComboBox

    '''<summary>
    '''cusProgramName control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents cusProgramName As Global.System.Web.UI.WebControls.CustomValidator
    ...
    '''<summary>
    '''rntxtCostExpected control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rntxtCostExpected As Global.Telerik.Web.UI.RadNumericTextBox
    ...
    '''<summary>
    '''rntxtCostActual control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents rntxtCostActual As Global.Telerik.Web.UI.RadNumericTextBox
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents txtCostDescription As Global.Telerik.Web.UI.RadTextBox
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents lstbForm As Global.Telerik.Web.UI.RadListBox

                            ...
                            <fieldset>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <tlk:RadTextBox ID="txtOrganizationName" runat="server" Width="95%" BorderStyle="None" ReadOnly="true" BorderWidth="0">
                                            </tlk:RadTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <tlk:RadTextBox ID="txtTitle" runat="server" Width="95%">
                                            </tlk:RadTextBox>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function btnCostallocateClick(sender, args) {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Recruitment&fid=ctrlRC_Costallocate&group=Business&Stage_ID=' + id, "rwPopup");
            var pos = $("html").offset();

...
Public Class ctrlRC_CadidateListDtlFamily
    Inherits CommonView
...
#Region "Page"
    ...
    Public Overrides Sub ViewLoad(ByVal e As System.EventArgs)
        Try
            'nếu báo lỗi đỏ sửa trong file designer.vb ctrlEmpBasicInfo As Global.Profile.ctrlEmpBasicInfo
            'fix ngoài view
...
#Region "Event"
        ...
        Try
            Select Case CType(e.Item, RadToolBarButton).CommandName
                ...
                Case TOOLBARITEM_CANCEL
                    ...
                    Response.Redirect("/Default.aspx?mid=Profile&fid=ctrlHU_EmpDtl&group=Business&emp=" + EmployeeInfo.ID.ToString() + "&Place=ctrlRC_CadidateListDtlFamily&state=Normal")
 ...
 Handles cboProvince_City1.ItemsRequested, cboDistrict1.ItemsRequested, cboCommune1.ItemsRequested,
    ...
    Private Sub chkDaMat_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkDaMat.CheckedChanged

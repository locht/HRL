     ...
     <asp:HiddenField ID="hidOrg" runat="server" />
      ...
      <fieldset style="height:70px">
           <legend>
              ...
              <table  class="table-form"> 
            <tr>
            <td> <tlk:RadListBox runat="server"  CssClass="horizontalListbox"
            ID="rlbStatus" CheckBoxes="true" AllowReorder="true" ShowCheckAll = "true" onclientitemchecked="onItemChecked" >
...
<%--            <Items>
            ...
            <td>
            <tlk:RadButton ID="btnSearch" runat="server" Text="<%$ Translate: Tìm kiếm %>"  >
             </tlk:RadButton>
             </td>
            </tr>
      </table>
  ...
  <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadTabStrip ID="rtabCandidateTransfer"  runat="server"
           ...
           <tlk:RadMultiPage ID="RadMultiPage1" SelectedIndex="0" runat="server" Width="100%" >
            <tlk:RadPageView ID="rpvElect" runat="server" Width="100%">
               <tlk:RadGrid ID="rgCandidateList" runat="server" Width="100%"   Height="400px" >
        ...
        <tlk:RadGrid ID="rgResult" runat="server" Height="400px" AllowFilteringByColumn="true">
          ...
          <tlk:RadPageView ID="rpvAspiration" runat="server" Width="100%">
           <tlk:RadGrid ID="rgAspiration" runat="server" Height="400px" Width="100%" AllowScroll="true">
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID,CANDIDATE_CODE,ID_CANDIDATE,PLACE_WORK,RECEIVE_FROM,RECEIVE_TO,PROBATION_FROM,PROBATION_TO">
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Họ tên %>" DataField="FULLNAME_VN"
                        ...
                        <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã nhân viên %>" DataField="EMPLOYEE_CODE"
                        UniqueName="EMPLOYEE_CODE" SortExpression="EMPLOYEE_CODE" />
                    <tlk:GridBoundColumn HeaderStyle-Width="90px"  HeaderText="<%$ Translate: Thời gian làm việc %>" DataField="TIME_WORK"
                        UniqueName="TIME_WORK" SortExpression="TIME_WORK" />
                    <tlk:GridTemplateColumn  HeaderStyle-Width="125px"  HeaderText="<%$ Translate: Nơi làm việc %>" DataField="PLACE_WORK"  SortExpression="PLACE_WORK" UniqueName="PLACE_WORK">
                                        <ItemTemplate>
                    ...
                    <tlk:GridTemplateColumn  HeaderStyle-Width="125px" HeaderText="<%$ Translate: Nhận việc từ ngày %>" DataField="RECEIVE_FROM"  SortExpression="RECEIVE_FROM" UniqueName="RECEIVE_FROM">
                                        <ItemTemplate>
                    ...
                    <tlk:GridTemplateColumn  HeaderStyle-Width="125px" HeaderText="<%$ Translate: Nhận việc đến ngày %>" DataField="RECEIVE_TO"  SortExpression="RECEIVE_TO" UniqueName="RECEIVE_TO">
                                        <ItemTemplate>
                    ...
                    <tlk:GridTemplateColumn  HeaderStyle-Width="125px" HeaderText="<%$ Translate: Thử việc từ ngày %>" DataField="PROBATION_FROM"  SortExpression="PROBATION_FROM" UniqueName="PROBATION_FROM">
                                        <ItemTemplate>
                                            <tlk:RadDatePicker ID="PROBATION_FROM" runat="server" Width="120px" DbSelectedDate='<%# (Eval("PROBATION_FROM")) %>'>
                                            </tlk:RadDatePicker>
                                        </ItemTemplate>
                             </tlk:GridTemplateColumn>
                    <tlk:GridTemplateColumn  HeaderStyle-Width="125px" HeaderText="<%$ Translate: Thử việc đến ngày %>" DataField="PROBATION_TO"  SortExpression="PROBATION_TO" UniqueName="PROBATION_TO">
                                        <ItemTemplate>
                                            <tlk:RadDatePicker ID="PROBATION_TO" runat="server" Width="120px" DbSelectedDate='<%# (Eval("PROBATION_TO")) %>' >
                                            </tlk:RadDatePicker>
                                        </ItemTemplate>
                             </tlk:GridTemplateColumn>
                    <tlk:GridBoundColumn HeaderStyle-Width="90px" HeaderText="<%$ Translate: Ngày bắt đầu làm việc %>" DataField="STARTDATE_WORK"
                        UniqueName="STARTDATE_WORK" SortExpression="STARTDATE_WORK" />
                    <tlk:GridBoundColumn HeaderStyle-Width="90px" HeaderText="<%$ Translate: Mức lương thử việc %>" DataField="PROBATION_SALARY"
                        UniqueName="PROBATION_SALARY" SortExpression="PROBATION_SALARY" />
                    <tlk:GridBoundColumn HeaderStyle-Width="90px" HeaderText="<%$ Translate: Mức lương chính thức %>" DataField="OFFICAL_SALARY"
      ...
      <tlk:RadPane ID="RadPane4" runat="server" Height="50px" Scrolling="None">
        <table  class="table-form">
            <tr>
               ...
               <td>
                    <tlk:RadButton ID="btnSendEmailReceive" runat="server" Text="<%$ Translate: Gửi email thư mời nhận việc %>"  OnClientClicked="DisableAjax"
                        >
                    </tlk:RadButton>
                </td>
                <td>
                    <tlk:RadButton ID="btnReceive" runat="server" Text="<%$ Translate: Thư mời nhận việc %>" OnClientClicked="DisableAjax"
                       >
                    </tlk:RadButton>
                </td>
                <td>
                    <tlk:RadButton ID="btnThankLetter" runat="server" Text="<%$ Translate: Thư cảm ơn %>" OnClientClicked="DisableAjax"
                       >
                    </tlk:RadButton>
                </td>
                <td>
                    <tlk:RadButton ID="btnTransfer" runat="server" Text="<%$ Translate: Chuyển sang HSNV %>"
                      >
                        ...
                        <td>
                    <tlk:RadButton ID="btnExportContract" runat="server" Text="<%$ Translate: Xuất tờ trình ký HĐLĐ thử việc %>" OnClientClicked="DisableAjax"
                       >
                    </tlk:RadButton>
                </td>
                <td>
                    <tlk:RadButton ID="btnLĐ" runat="server" Text="<%$ Translate: Gửi email thông báo tiếp nhận LĐ thử việc  %>" OnClientClicked="DisableAjax"
                      >
                    </tlk:RadButton>
                </td>
            </tr>

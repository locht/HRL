                ...
                <tlk:RadPanelItem Text="<%$ Translate:Hồ sơ ứng viên %>" Expanded="True">
                    <Items>
                        <tlk:RadPanelItem Value="ctrlRC_CVPoolDtlProfile" Text="<%$ Translate:Hồ sơ ứng viên%>"
                            NavigateUrl='<%# String.Format("/Dialog.aspx?mid=Recruitment&fid=ctrlRC_CVPoolDtl&group=Business&Can={0}&Place=ctrlRC_CVPoolDtlProfile&noscroll=1&state=Normal", CandidateCode) %>' />
                        <tlk:RadPanelItem Value="ctrlRC_CVPoolDtlBeforeWT" Text="<%$ Translate:Quá trình công tác%>"
                            NavigateUrl='<%# String.Format("/Dialog.aspx?mid=Recruitment&fid=ctrlRC_CVPoolDtl&group=Business&Can={0}&PROGRAM_ID={1}&Place=ctrlRC_CVPoolDtlBeforeWT&noscroll=1&state=Normal", CandidateCode, ProgramID) %>' />
                        <tlk:RadPanelItem Value="ctrlRC_CVPoolDtlFamily" Text="<%$ Translate:Quan hệ thân nhân%>"
                            NavigateUrl='<%# String.Format("/Dialog.aspx?mid=Recruitment&fid=ctrlRC_CVPoolDtl&group=Business&Can={0}&PROGRAM_ID={1}&Place=ctrlRC_CVPoolDtlFamily&noscroll=1&state=Normal", CandidateCode, ProgramID) %>' />
                        <tlk:RadPanelItem Value="ctrlRC_CVPoolDtlTraining" Text="<%$ Translate:Quá trình đào tạo%>"
                            NavigateUrl='<%# String.Format("/Dialog.aspx?mid=Recruitment&fid=ctrlRC_CVPoolDtl&group=Business&Can={0}&PROGRAM_ID={1}&Place=ctrlRC_CVPoolDtlTraining&noscroll=1&state=Normal", CandidateCode, ProgramID) %>' />
                        <tlk:RadPanelItem Value="ctrlRC_CadidateReference" Text="<%$ Translate:Người tham chiếu%>"
                            NavigateUrl='<%# String.Format("/Dialog.aspx?mid=Recruitment&fid=ctrlRC_CVPoolDtl&group=Business&Can={0}&PROGRAM_ID={1}&Place=ctrlRC_CVPoolReference&noscroll=1&state=Normal", CandidateCode, ProgramID) %>' />
                    </Items>
                </tlk:RadPanelItem>
            </Items>
        </tlk:RadPanelBar>

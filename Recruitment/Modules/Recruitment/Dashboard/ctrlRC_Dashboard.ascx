<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRC_Dashboard.ascx.vb"
    Inherits="Recruitment.ctrlRC_Dashboard" %>
    ...
    <script type="text/javascript">
        ...
        function SizeToFit(resize) {
            ...
            window.setTimeout(function () {
                ...
                oWnd4.setSize(winW + 100, winH / 2);
                oWnd4.moveTo(left + winW * 2 - 100, top + winH / 2);
                if (i4 == 0) {

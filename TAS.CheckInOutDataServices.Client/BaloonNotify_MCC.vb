Partial Public Class frmMain_MCC
...
#Region "NotifyIcon"
    Private Sub InitNotifyIcon()
        ...
        If cmdStart.Visible = True Then
            notifyIcon.Text = "TAS.Services: Read IO data is working..."
            notifyIcon.BalloonTipText = "TAS.Services: Read IO data is working..."
        Else
            notifyIcon.Text = "TAS.Services: Read IO data has stopped working"
            notifyIcon.BalloonTipText = "TAS.Services: Read IO data has stopped working"
        End If
...
#Region "Funtion Write Log"
    ...
    Private Sub TS_AddLogText(text As String)
        ...
        Else
            ...
            WriteLog.WriteAllText(g_strFolderLogMCC, g_strLogFile_MCC, text)
            'CLEAR LOG TEXT BOX

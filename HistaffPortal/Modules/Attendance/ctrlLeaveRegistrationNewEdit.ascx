    ...
    <tlk:RadPane ID="RadPane1" runat="server" Height="100%" Scrolling="Y">
        ...
        <tlk:RadGrid ID="rgEmployee" AllowPaging="false" AllowMultiRowEdit="true" runat="server">
            ...
            <MasterTableView EditMode="InPlace" EditFormSettings-EditFormType="AutoGenerated"
                AllowPaging="false" AllowCustomPaging="false" DataKeyNames="ID,EMPLOYEE_CODE,ORG_ID,ORG_NAME,TITLE_ID,FULLNAME_VN,TITLE_NAME_VN,EMPLOYEE_OBJECT_CODE,EMP_ENTITLEMENT"
                ClientDataKeyNames="ID,EMPLOYEE_CODE,ORG_ID,TITLE_ID,FULLNAME_VN,TITLE_NAME_VN,ORG_NAME,EMPLOYEE_OBJECT_CODE,EMP_ENTITLEMENT"

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlRegisterLeave.ascx.vb"
    Inherits="Attendance.ctrlRegisterLeave" %>
...
<tlk:RadSplitter runat="server" ID="splitFull" Orientation="Horizontal" Width="100%"
    Height="100%">
    <tlk:RadPane runat="server" ID="pnlRegistInfo" Height="100px" Visible="true" Scrolling="None">
        <table class="table-form">
            <tr>
                ...
                <td colspan="3">
                    <tlk:RadComboBox runat="server" ID="cboleaveType" Width="400px" DataTextField="NAME_VN"
                        DataValueField="ID" AutoPostBack="true">
                    </tlk:RadComboBox>
                </td>
                <td rowspan="5" class="tdNotie">
                    <div id="noties" runat="server">
                        <span class="lbllegen">Tổng số ngày phép được nghỉ:</span>
                        <br />
                        <span class="lbllegen">Tổng số ngày phép đã nghỉ:</span>
                        <br />
                        <span class="lbllegen">Số ngày phép còn lại:</span>
                        <br />
                        <span class="lbllegen">Số ngày giới hạn/lần:</span>
                        <br />
                        <span class="lbllegen">Số ngày giới hạn/năm:</span>
                        <br />
                    </div>
                </td>
                <td rowspan="5">
                    <span class="lblNumber">
                        <asp:Label ID="lblNgayDuocNghi" runat="server"></asp:Label></span>
                    <br />
                    <span class="lblNumber">
                        <asp:Label ID="lblNgayDaNghi" runat="server"></asp:Label></span>
                    <br />
                    <span class="lblNumber">
                        <asp:Label ID="lblConLai" runat="server"></asp:Label></span>
                    <br />
                    <span class="lblNumber">
                ...
                <td rowspan="5" class="tdNotie">
                    <div id="noties1" runat="server">
                        <span class="lbllegen">Phép cũ chuyển qua:</span>
                        <br />
                        <span class="lbllegen">Phép cũ đã nghỉ:</span>
                        <br />
                        <span class="lbllegen">Phép cũ còn lại:</span>
                        <br />
                        <span class="lbllegen">Phép thâm niên:</span>
                        <br />
                        <span class="lbllegen">Phép chuẩn năm nay:</span>
                        <br />
                    </div>
                </td>
                <td rowspan="5">
                    <span class="lblNumber">
                        <asp:Label ID="lblPREV_HAVE" runat="server"></asp:Label></span>
                    <br />
                    <span class="lblNumber">
                        <asp:Label ID="lblPREV_USED" runat="server"></asp:Label></span>
                    <br />
                    <span class="lblNumber">
                        <asp:Label ID="lblPREVTOTAL_HAVE" runat="server"></asp:Label></span>
                    <br />
                    <span class="lblNumber">
                        <asp:Label ID="lblSENIORITYHAVE" runat="server"></asp:Label></span>
                    <br />
                    <span class="lblNumber">
                        <asp:Label ID="lblTOTAL_HAVE1" runat="server"></asp:Label></span>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <tlk:RadTextBox runat="server" ID="txtReason" Width="400px">
                    </tlk:RadTextBox>
                </td>
            </tr>
               <tr>
                ...
                <td colspan="3">
                    <tlk:RadTextBox runat="server" ID="txtCancle" Width="400px">
                    </tlk:RadTextBox>
                </td>
            </tr>
        </table>
    </tlk:RadPane>
    <tlk:RadPane runat="server" ID="RadPane1" Height="45px" Visible="true">
        <div style="vertical-align: middle; height: 40px; padding-top: 5px">
            ...
            <br />
            <b style="color: Red;">Chú ý: </b><b>Chuột phải để đăng ký, gửi duyệt hoặc xóa đăng
                ký nghỉ</b>
        </div>
    </tlk:RadPane>
    <tlk:RadPane runat="server" ID="pnlSchedule" Scrolling="None" Visible="true" Height="530px">
        <tlk:RadScheduler runat="server" ID="sdlRegister" Height="100%" SelectedView="MonthView"
            ...
            WorkDayEndTime="23:59:59" OnClientTimeSlotContextMenuItemClicking="OnClientTimeSlotContextMenuItemClicking"

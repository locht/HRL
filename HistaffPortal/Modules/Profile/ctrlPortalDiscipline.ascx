    ...
    <MasterTableView DataKeyNames="ID">
        <Columns>
            ...
            <tlk:GridDateTimeColumn HeaderText="<%$ Translate: Ngày hiệu lực %>" DataField="EFFECT_DATE"
             ...
             <tlk:GridDateTimeColumn HeaderText="<%$ Translate: Ngày vi phạm %>" DataField="DISCIPLINE_DATE"
            ...
            <tlk:GridNumericColumn HeaderText="<%$ Translate: Tiền phạt %>" DataField="MONEY" UniqueName="MONEY"

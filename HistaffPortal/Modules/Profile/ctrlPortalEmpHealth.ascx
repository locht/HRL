<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPortalEmpHealth.ascx.vb"
    Inherits="Profile.ctrlPortalEmpHealth" %>
<tlk:RadGrid PageSize="50" ID="rgHealth" runat="server" Height="350px" AllowFilteringByColumn="true" Scrolling="both">

...
<span class="title-dbportal">Khóa đào tạo theo chức danh</span>
<div class="boxdbPortalScroll">
    <tlk:RadGrid PageSize="50" ID="rgData" runat="server" Height="153px" Width="870px" AllowFilteringByColumn="false">

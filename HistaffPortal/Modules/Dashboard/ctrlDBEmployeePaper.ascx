<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDBEmployeePaper.ascx.vb"
    Inherits="Profile.ctrlDBEmployeePaper" %>
<style type="text/css">
    .lblInfo
    {
        font-weight: bold;
...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="95%" Height="100%" Orientation="Horizontal"
    ...
    <tlk:RadPane ID="EmpReg" runat="server" Scrolling="None">
        <span class="title-dbportal">Tình trạng giấy tờ</span>
        <div class="boxdbPortal">
            <tlk:RadListBox ID="lstbPaperFiled" CheckBoxes="true" runat="server" Height="167px" Enabled="false"
                Width="100%">
            </tlk:RadListBox>
        </div>
    </tlk:RadPane>

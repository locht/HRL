...
<span class="title-dbportal">Chứng chỉ đào tạo hết hạn</span>
<div class="boxdbPortalScroll">
    <tlk:RadGrid PageSize="50" ID="rgData" runat="server" Height="153px" Width="620px"
        AllowFilteringByColumn="false">
        <MasterTableView DataKeyNames="CERTIFICATE_ID" ClientDataKeyNames="CERTIFICATE_ID">
            <Columns>

...
<tlk:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%">
    <tlk:RadPane ID="MainPane" runat="server">
        <tlk:RadGrid PageSize=50 ID="rgTitle" runat="server" Height="350px" AllowFilteringByColumn="true">
            <MasterTableView DataKeyNames="ID">
                <Columns>
                    <tlk:GridBoundColumn DataField="ID" HeaderStyle-Width="0px" />
                    ...
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Tên chức danh TA %>" DataField="NAME_EN"
                        ...
                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Tên Global %>" DataField="GLOBAL_NAME"
                        SortExpression="GLOBAL_NAME" UniqueName="GLOBAL_NAME" ShowFilterIcon="false"
                        FilterControlWidth="95%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Work level %>" DataField="WORKLEVEL_NAME"
                        SortExpression="WORKLEVEL_NAME" UniqueName="WORKLEVEL_NAME" ShowFilterIcon="false"
                        FilterControlWidth="95%" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" />
                </Columns>
            </MasterTableView>
        </tlk:RadGrid>

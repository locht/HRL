...
#Region "contract appendix"
        Public Function GET_NEXT_APPENDIX_ORDER(ByVal contract_id As Decimal, ByVal emp_id As Decimal) As Integer Implements ServiceContracts.IProfileBusiness.GET_NEXT_APPENDIX_ORDER
            Using rep As New ProfileRepository
                Try

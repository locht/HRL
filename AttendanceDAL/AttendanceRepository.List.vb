        ...
        Try
            ...
            Dim lst = query.Select(Function(p) New AT_SymbolsDTO With {
                                       ...
                                       .WDATAMODE_NAME = p.DATAMODE.NAME_VN,
                                        ...
                                        .IS_DISPLAY_NAME = If(p.p.IS_DISPLAY = -1, "X", ""),
                                        .IS_DATAFROMEXCEL = p.p.IS_DATAFROMEXCEL,
                                        .IS_DATAFROMEXCEL_NAME = If(p.p.IS_DATAFROMEXCEL = -1, "X", ""),
                                        .IS_DISPLAY_PORTAL = p.p.IS_DISPLAY_PORTAL,
                                        .IS_DISPLAY_PORTAL_NAME = If(p.p.IS_DISPLAY_PORTAL = -1, "X", ""),
                                        .IS_LEAVE = p.p.IS_LEAVE,
                                        .IS_LEAVE_NAME = If(p.p.IS_LEAVE = -1, "X", ""),
                                        .IS_LEAVE_WEEKLY = p.p.IS_LEAVE_WEEKLY,
                                        .IS_LEAVE_WEEKLY_NAME = If(p.p.IS_LEAVE_WEEKLY = -1, "X", ""),
                                        .IS_LEAVE_HOLIDAY = p.p.IS_LEAVE_HOLIDAY,
                                        .IS_LEAVE_HOLIDAY_NAME = If(p.p.IS_LEAVE_HOLIDAY = -1, "X", ""),
                                        .IS_DAY_HALF = p.p.IS_DAY_HALF,
                                        .IS_DAY_HALF_NAME = If(p.p.IS_DAY_HALF = -1, "X", ""),

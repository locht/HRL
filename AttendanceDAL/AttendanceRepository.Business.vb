    ...
    Public Function GetEntitlement(ByVal _filter As AT_ENTITLEMENTDTO,
        ...
        Try
            ...
            Dim lst = query.Select(Function(p) New AT_ENTITLEMENTDTO With {
                                       ...
                                       .CUR_USED1 = If(thang >= 1, p.en.CUR_USED1, 0),
                                       ...
                                       .PREV_USED1 = If(thang >= 1, p.en.PREV_USED1, 0),
                                       .PREV_USED2 = If(thang >= 2, p.en.PREV_USED2, 0),
                                       .PREV_USED3 = If(thang >= 3, p.en.PREV_USED3, 0),
                                       .PREV_USED4 = If(thang >= 4, p.en.PREV_USED4, 0),
                                       .PREV_USED5 = If(thang >= 5, p.en.PREV_USED5, 0),
                                       .PREV_USED6 = If(thang >= 6, p.en.PREV_USED6, 0),
                                       .PREV_USED7 = If(thang >= 7, p.en.PREV_USED7, 0),
                                       .PREV_USED8 = If(thang >= 8, p.en.PREV_USED8, 0),
                                       .PREV_USED9 = If(thang >= 9, p.en.PREV_USED9, 0),
                                       .PREV_USED10 = If(thang >= 10, p.en.PREV_USED10, 0),
                                       .PREV_USED11 = If(thang >= 11, p.en.PREV_USED11, 0),
                                       .PREV_USED12 = If(thang >= 12, p.en.PREV_USED12, 0),

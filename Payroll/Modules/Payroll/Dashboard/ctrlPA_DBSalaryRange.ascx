<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPA_DBSalaryRange.ascx.vb"
    Inherits="Payroll.ctrlPA_DBSalaryRange" %>
...
<%--<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Thống kê số lượng nhân viên theo khoảng lương")%></span>
</div>--%>
        ...
        $(function () {
            ...
            $('#container').highcharts({
             credits: {
                ...
                title: {
                            text:'<span style="font-weight: bold;color: #767676;font-size:12px;"><%# Translate("Thống kê số lượng nhân viên theo khoảng lương")%></span>'
                        }
            });
        });
    }

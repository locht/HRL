<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPL_DBSalary.ascx.vb"
    Inherits="Payroll.ctrlPL_DBSalary" %>
...
<div class="box-headchart">
    <span class="headchart"><%# Translate("Quỹ lương")%></span>
</div>
...
//                oWnd.setUrl('Dialog.aspx?mid=Payroll&fid=ctrlPL_DBSalary&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
//                break;
//            case "Restore":
//                oWnd.restore();

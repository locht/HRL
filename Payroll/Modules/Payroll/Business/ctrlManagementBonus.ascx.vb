...
Public Class ctrlManagementBonus
    ...
    Protected Sub CreateDataFilter()
        ...
        Try
            ...
            If Sorts Is Nothing Then
                ' vData = New DataTable
                vData = rep.GetListManagementBonus(Utilities.ObjToInt((13)), Utilities.ObjToInt(cboPeriod.SelectedValue), Utilities.ObjToInt(ctrlOrg.CurrentValue), ctrlOrg.IsDissolve, Utilities.ObjToString(rtxtEmployee.Text))
            Else
                'vData = New DataTable

<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlSendMailLuong.ascx.vb"
    Inherits="Payroll.ctrlSendMailLuong" %>
                ...
                <tlk:RadSplitter ID="RadSplitter2" runat="server" Width="100%" Height="100%">
                    ...
                    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
                        <tlk:RadGrid PageSize="50" ID="rgData" runat="server" Height="100%">
                            ...
                            <MasterTableView DataKeyNames="ID,MONTH_DATE,WORK_EMAIL" ClientDataKeyNames="ID,EMPLOYEE_CODE,FULLNAME_VN,ORG_NAME,MONTH_DATE,WORK_EMAIL">
                                <Columns>

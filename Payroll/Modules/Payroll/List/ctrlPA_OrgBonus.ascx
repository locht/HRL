<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlPA_OrgBonus.ascx.vb"
    Inherits="Payroll.ctrlPA_OrgBonus" %>
...
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="RadPane1" runat="server" Height="165px" Scrolling="None">
        ...
        <table class="table-form">
            <tr>
                <td class="lb">
                    <%# Translate("Mã đơn vị quỹ thưởng")%><span class="lbReq">*</span>
                </td>
                <td>
                ...
                <td class="lb">
                    <%# Translate("Tên đơn vị quỹ thưởng")%><span class="lbReq">*</span>
                </td>
                <td>
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid ID="rgData" runat="server" Height="100%">
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="CODE,NAME,ORDERS,ACTFLG,REMARK">
                <Columns>
                    <tlk:GridClientSelectColumn UniqueName="cbStatus" HeaderStyle-HorizontalAlign="Center"
                        HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                    </tlk:GridClientSelectColumn>
                    <tlk:GridBoundColumn DataField="ID" Visible="false" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã đơn vị quỹ thưởng %>" DataField="CODE" SortExpression="CODE"
                        UniqueName="CODE" />
                    <tlk:GridBoundColumn HeaderText="<%$ Translate: Tên đơn vị quỹ thưởng %>" DataField="NAME" SortExpression="NAME"
                        UniqueName="NAME" />

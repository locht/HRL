<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDBEmployeeStatisticEducation.ascx.vb"
    Inherits="Profile.ctrlDBEmployeeStatisticEducation" %>
...
<div class="box-headchart">
    <span class="headchart">
        <%# Translate("Mức độ gắn bó của nhân viên")%></span>
</div>
    ...
    function MaxClick(sender, e) {
        ...
        switch (btnText) {
            case "Maximize":
                ...
                oWnd.setUrl('Dialog.aspx?mid=Profile&fid=ctrlDBEmployeeStatisticEducation&group=Dashboard&width=' + (winW) + '&height=' + (winH - 80) + "&noscroll=1&reload=1&resize=" + 1);
                break;
            case "Restore":
                oWnd.restore();

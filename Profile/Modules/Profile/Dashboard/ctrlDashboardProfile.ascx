<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDashboardProfile.ascx.vb"
    Inherits="Profile.ctrlDashboardProfile" %>
    ...
    <script type="text/javascript">
        ...
        function SizeToFit(resize) {
            ...
            window.setTimeout(function () {
                ...
                if (i3 == 0) {
                    radopen('Dialog.aspx?mid=Profile&fid=ctrlDBInfoProfile&group=Dashboard&width=' + (oWnd1.get_width() - 20) + '&height=' + (oWnd1.get_height() - 80) + "&noscroll=1&resize=" + resize, "rw3");
                    i3 = 1;
                }

            ...
            <tlk:RadPane ID="RadPane1" runat="server" Height="40px" Scrolling="None">
                <table class="table-form">
                    <tr>
                        ...
                        <td>
                            <tlk:RadButton runat="server" Text="<%$ Translate: Tìm kiếm %>" ID="btnSearch" SkinID="ButtonFind">
                            </tlk:RadButton>
                        </td>
                    </tr>
                </table>
...
<tlk:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OpenNew() {
            var oWindow = radopen('Dialog.aspx?mid=Profile&fid=ctrlHU_Terminate3BNewEdit&group=Business&FormType=0&noscroll=1', "rwPopup");
            var pos = $("html").offset();
        ...
        function OpenEdit() {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Profile&fid=ctrlHU_Terminate3BNewEdit&group=Business&FormType=1&noscroll=1&ID=' + id, "rwPopup");
            var pos = $("html").offset();
            oWindow.setSize(1020, $(window).height());
            oWindow.center();
        }
        ...
        function OpenView() {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Profile&fid=ctrlHU_Terminate3BNewEdit&group=Business&FormType=2&noscroll=1&ID=' + id, "rwPopup");
            var pos = $("html").offset();
            oWindow.setSize(1020, $(window).height());
            oWindow.center();
        }

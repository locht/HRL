...
#Region "Custom"
    ...
    Protected Function CreateDataFilter(Optional ByVal isFull As Boolean = False) As DataTable
        ...
        Try
            ...
            Else
                If Sorts IsNot Nothing Then
                    rgData.DataSource = rep.GetApproveWorkingBeforeEdit(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param, Sorts)
                Else
                    rgData.DataSource = rep.GetApproveWorkingBeforeEdit(_filter, rgData.CurrentPageIndex, rgData.PageSize, MaximumRows, _param)
                End If
                rep.Dispose()

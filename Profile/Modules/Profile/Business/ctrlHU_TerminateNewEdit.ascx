                        ...
                        <MasterTableView EditMode="PopUp" DataKeyNames="DEBT_TYPE_ID,DEBT_TYPE_NAME,MONEY,ID,DEBT_STATUS,DEBT_STATUS_NAME,REMARK"
                                ...
                                <div style="padding: 2px 0 0 0">
                                    <div style="float: left">
                                        <tlk:RadButton ID="btnAddDebt" runat="server" Icon-PrimaryIconUrl="~/Static/Images/Toolbar/add.png"
                                            CommandName="btnAddDebt" CausesValidation="false" Width="70px" Text="<%$ Translate: Thêm %>"
                                            OnClientClicking="btnAddDebtsOnClientClicking">
                                        </tlk:RadButton>
                                    </div>
                                    <%--<div style="float: left">
                                        <tlk:RadButton ID="btnEditDebt" runat="server" Icon-PrimaryIconUrl="~/Static/Images/Toolbar/edit.png"
                                            CommandName="btnEditDebt" CausesValidation="false" Width="70px" Text="<%$ Translate: Sửa %>"
                                            OnClientClicking="btnEditDebtsOnClientClicking">
                                        </tlk:RadButton>
                                    </div>--%>
                                    <div style="float: right">
                                        <tlk:RadButton ID="btnDeleteDebts" runat="server" CommandName="btnDeleteDebts" Icon-PrimaryIconUrl="~/Static/Images/Toolbar/delete.png"
                            ...
                            <Columns>
                                ...
                                <tlk:GridNumericColumn HeaderText="<%$ Translate: Số tiền %>" DataField="MONEY" SortExpression="MONEY"
                                    UniqueName="MONEY" DataFormatString="{0:n0}" ReadOnly="true">
                                ...
                                <tlk:GridBoundColumn HeaderText="<%$ Translate: Ghi chú %>" DataField="REMARK" SortExpression="REMARK"
                                    UniqueName="REMARK" ReadOnly="true" />
                            </Columns>

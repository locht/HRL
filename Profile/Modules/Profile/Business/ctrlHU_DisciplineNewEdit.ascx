    ...
    <tlk:RadPane ID="RadPane2" runat="server" Height="350px">
        ...
        <table class="table-form" onkeydown="return (event.keyCode!=13)">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="reqDecisionNo" ControlToValidate="txtDecisionNo"
                        runat="server" ErrorMessage="Bạn phải nhập số quyết định." ToolTip="Bạn phải nhập số quyết định."> 
                    </asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="lb">
                    <asp:Label runat="server" ID="lbDateNotice" Text="Ngày ban hành"></asp:Label>
                </td>
                <td>
                    <tlk:RadDatePicker runat="server" ID="rdDateNotice">
                    </tlk:RadDatePicker>
                </td>
                <td class="lb">
            ...
            <tr>
                ...
                <td>
                    ...
                    <tlk:RadTextBox ID="txtSignerName" Width="130px" runat="server" ReadOnly="true" SkinID="ReadOnly"
                        TabIndex="7">
                    </tlk:RadTextBox>
            ...
            <tr>
                <td class="lb">
                    <asp:Label runat="server" ID="lbDisciplineObj" Text="Đối tượng kỷ luật"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:CustomValidator ID="cvalDisciplineObj" ControlToValidate="cboDisciplineObj"
                        runat="server" ErrorMessage="Đối tượng không tồn tại hoặc đã ngừng áp dụng."
                ...
                <td class="lb">
                    <asp:Label runat="server" ID="lbDisciplineType" Text="Hình thức kỷ luật"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:CustomValidator ID="cvalDisciplineType" ControlToValidate="cboDisciplineType"
                        runat="server" ErrorMessage="Hình thức kỷ luật không tồn tại hoặc đã ngừng áp dụng."
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="cvalDisciplineReason" ControlToValidate="cboDisciplineReason"
                        runat="server" ErrorMessage="Lý do kỷ luật không tồn tại hoặc đã ngừng áp dụng."
                        ToolTip="Lý do kỷ luật không tồn tại hoặc đã ngừng áp dụng.">
                    </asp:CustomValidator>
                </td>
                <td class="lb">
                    <asp:Label runat="server" ID="lbDisciplineReasonDetail" Text="Chế tài áp dụng"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="lb">
                    ...
                    <asp:Label runat="server" ID="lbPaidIMoeny" Text="Tổng số tiền bồi thường"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="lb">
                    <asp:Label runat="server" ID="Label2" Text="Tiền bồi thường vật chất"></asp:Label>
                </td>
                <td>
                    <tlk:RadNumericTextBox runat="server" ID="rnMaterial">
                    </tlk:RadNumericTextBox>
                </td>
                <td class="lb">
                </td>
                <td>
                    <asp:CheckBox ID="chkDeductFromSalary" runat="server" Text="Trừ vào lương" Checked="false"
                        CausesValidation="false" TextAlign="Right" AutoPostBack="true" />
                </td>
            </tr>
            <tr>
                <td class="lb" style="display: none">
                ...
                <td style="display: none">
                    <tlk:RadNumericTextBox ID="rnAmountSalaryMonth" runat="server" SkinID="Money" TabIndex="24"
                        Enabled="false">
                    </tlk:RadNumericTextBox>
                ...
                <td class="lb">
                    <asp:Label runat="server" ID="lnYear" Text="Năm"></asp:Label>
                </td>
                <td>
                    <tlk:RadNumericTextBox ID="nmYear" runat="server" AutoPostBack="true" Enabled="false"
                        TabIndex="26" MaxLength="4" MinValue="1900" SkinID="Number">
                    </tlk:RadNumericTextBox>
                </td>
                <td class="lb">
                ...
                <td colspan="2">
                    ...
                    <tlk:RadButton ID="btnDownload" runat="server" Text="Tải xuống" CausesValidation="false"
                        OnClientClicked="rbtClicked" TabIndex="5" EnableViewState="false">
                    </tlk:RadButton>
                </td>
            </tr>
            <tr>
            ...
            <tr style="display: none">
                ...
                <td>
                    <tlk:RadNumericTextBox ID="rdAmountPaidCash" runat="server" SkinID="Money" TabIndex="22"
                        AutoPostBack="true">
                    </tlk:RadNumericTextBox>
                </td>
                <td class="lb">
            ...
            <tr style="display: none">
                <td class="lb">
                    <asp:CheckBox ID="chkAmountInMonth" runat="server" Checked="false" CausesValidation="false"
                        AutoPostBack="true" Enabled="false" />
                    <asp:Label runat="server" ID="lbAmountInMonth" Text="Tỷ lệ trừ vào mỗi tháng lương"></asp:Label>
                </td>
                <td>
                    <tlk:RadNumericTextBox ID="rnAmountInMonth" runat="server" SkinID="Money" TabIndex="27"
                        Enabled="false">
                    </tlk:RadNumericTextBox>
                </td>
                <td class="lb">
                ...
                <td>
                    <tlk:RadNumericTextBox ID="rnAmountDeductedMonth" runat="server" SkinID="Money" TabIndex="29"
                        Enabled="false">
                    </tlk:RadNumericTextBox>
                </td>
            </tr>
            ...
            <tr style="display: none">
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="cvalDisciplineLevel" ControlToValidate="cboDisciplineLevel"
                        runat="server" ErrorMessage="Cấp kỷ luật không tồn tại hoặc đã ngừng áp dụng."
    ...
    <tlk:RadPane runat="server" Scrolling="none" ID="PanelEmployee" Height="100%">
        <tlk:RadGrid PageSize="50" ID="rgEmployee" AllowPaging="false" AllowMultiRowEdit="true"
            ...
            <MasterTableView EditMode="InPlace" AllowPaging="false" AllowCustomPaging="false"
                DataKeyNames="HU_DISCIPLINE_ID,HU_EMPLOYEE_ID,EMPLOYEE_CODE,FULLNAME,TITLE_NAME,ORG_NAME,MONEY,INDEMNIFY_MONEY,NO_PROCESS"
                ClientDataKeyNames="HU_DISCIPLINE_ID,HU_EMPLOYEE_ID,EMPLOYEE_CODE,FULLNAME,TITLE_NAME,ORG_NAME,MONEY,INDEMNIFY_MONEY,NO_PROCESS"
                ...
                <CommandItemTemplate>
                    <div style="padding: 2px 0 0 0">
                        <div style="float: left">
                            ...
                            <%--<tlk:RadButton Width="100px" ID="btnQD" runat="server" Text="Tạo Quyết định" CausesValidation="false"
                                CommandName="CreateQD">
                            </tlk:RadButton>
                ...
                <Columns>
                    ...
                    <tlk:GridBoundColumn HeaderText="Mã nhân viên" DataField="EMPLOYEE_CODE" ReadOnly="true"
                        UniqueName="EMPLOYEE_CODE" SortExpression="EMPLOYEE_CODE" Aggregate="Count" FooterText="Tổng: ">
                    ...
                    <tlk:GridNumericColumn HeaderText="Số tiền phải nộp" DataField="INDEMNIFY_MONEY"

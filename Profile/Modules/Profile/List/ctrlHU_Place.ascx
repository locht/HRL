...
<tlk:RadSplitter ID="RadSplitter2" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
    <tlk:RadPane ID="TopPanel" runat="server" MinHeight="30" Height="30px" Scrolling="None">
        <tlk:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" 
            CausesValidation="False" SelectedIndex="3">
            <Tabs>
                <tlk:RadTab runat="server" PageViewID="rpvNations" 
                    Text="<%$ Translate: Quốc gia %>">
                </tlk:RadTab>
                ...
                <tlk:RadTab runat="server" PageViewID="rpvWard" 
                    Text="<%$ Translate: Xã phường %>" Selected="True">
                </tlk:RadTab>
            </Tabs>
        </tlk:RadTabStrip>
    </tlk:RadPane>
    <tlk:RadPane ID="MainPane" runat="server" Scrolling=None>
        <tlk:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="3" 
            Width="100%">

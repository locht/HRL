...
<tlk:RadScriptBlock ID="scriptBlock" runat="server">
    <script type="text/javascript">
        ...
        function OpenEditWindow(states) {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Competency&fid=ctrlHU_CompetencyAssNewEdit&group=Business&emp=' + empId + '&id=' + id + '&noscroll=1&periodid=' + vPeriod + '&year=' + vYear, "rwPopup");
            var pos = $("html").offset();
        ...
        function OpenInsertWindow() {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Competency&fid=ctrlHU_CompetencyAssNewEdit&group=Business&state=New&noscroll=1&reload=1&periodid=' + vPeriod + '&year=' + vYear, "rwPopup");
            var pos = $("html").offset();
            oWindow.moveTo(pos.left, pos.top);
            oWindow.setSize(1020, $(window).height());
            oWindow.center();

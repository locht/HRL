    ...
    <tlk:RadPane ID="RightPane" runat="server" Height="360px">
        ...
        <tlk:RadGrid ID="rgEmployee" AllowPaging="false" AllowMultiRowEdit="true" runat="server"
            ...
            <MasterTableView EditMode="InPlace" EditFormSettings-EditFormType="AutoGenerated"
                AllowPaging="false" AllowCustomPaging="false" DataKeyNames="ID,HU_EMPLOYEE_ID,EMPLOYEE_CODE,ORG_ID,TITLE_ID,FULLNAME,TITLE_NAME"
                ClientDataKeyNames="ID,HU_EMPLOYEE_ID,EMPLOYEE_CODE,ORG_ID,TITLE_ID,FULLNAME,TITLE_NAME,ORG_NAME"
                ...
                <Columns>
                    ...
                    <tlk:GridBoundColumn DataField="ORG_ID" UniqueName="ORG_ID"
                        HeaderStyle-Width="200px" ReadOnly="true" SortExpression="ORG_ID" Visible="false" />

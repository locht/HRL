    ...
    <tlk:RadPane ID="RadPane1" runat="server" Height="100%" Scrolling="Y">
        <table class="table-form" onkeydown="return (event.keyCode!=13)">
            ...
            <tr>
                ...
                <td>
                    <tlk:RadComboBox runat="server" ID="cboFromSession" DataTextField="NAME_VN" DataValueField="ID">
                    </tlk:RadComboBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <tlk:RadComboBox runat="server" ID="cboToSession" DataTextField="NAME_VN" DataValueField="ID">
                    </tlk:RadComboBox>
                </td>
            </tr>
            <tr>
                <td class="lb">
                    <%# Translate("Lý do nghỉ phép")%><span class="lbReq">*</span>
                </td>
                <td>

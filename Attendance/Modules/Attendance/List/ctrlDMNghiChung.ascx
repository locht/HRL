<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlDMNghiChung.ascx.vb"
    Inherits="Attendance.ctrlDMNghiChung" %>
<tlk:RadSplitter ID="RadSplitter3" runat="server" Width="100%" Height="100%" Orientation="Horizontal">
        ...
        <table class="table-form">
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="cvalCode" ControlToValidate="txtCode" runat="server" ErrorMessage="<%$ Translate: Mã ngày nghỉ đã tồn tại. %>"
                        ToolTip="<%$ Translate: Mã ngày nghỉ đã tồn tại. %>">
                    </asp:CustomValidator>
    ...
    <tlk:RadPane ID="RadPane2" runat="server" Scrolling="None">
        <tlk:RadGrid PageSize=50 ID="rgDanhMuc" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            ...
            <MasterTableView DataKeyNames="ID" ClientDataKeyNames="ID,CODE,NAME_VN,NAME_EN,WORKINGDAY,ACTFLG,NOTE">
                <Columns>

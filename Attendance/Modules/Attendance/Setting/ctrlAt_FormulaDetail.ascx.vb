...
Public Class ctrlAt_FormulaDetail
...
#Region "Property"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property vListSalary As DataTable
        Get
...
#Region "Page"
    ...
    Public Overrides Sub BindData()
        ...
        Try
            ...
            dic.Add("FINDEX", rnmIndex)
            dic.Add("FORMULAR", txtFormula)
...
#Region "Event"
            ...
            Select Case CType(e.Item, RadToolBarButton).CommandName
                Case CommonMessage.TOOLBARITEM_APPROVE
                    ...
                    Using rep As New AttendanceRepository
                        If Not rep.CheckFomuler(item("WCODE").Text.ToUpper(), Utilities.ObjToString(txtFormula.Text.Trim), iGrpFomul) Then
                ...
                Case CommonMessage.TOOLBARITEM_SAVE
                    ...
                    EnabledGrid(rgData, False)
                    Dim item As GridDataItem = rgData.SelectedItems(0)
                    Dim obj As New ATFml_DetailDTO
                    obj.WCODE = item("WCODE").Text
                    obj.FINDEX = Utilities.ObjToDecima(rnmIndex.Value)
                    obj.FORMULAR = Utilities.ObjToString(txtFormula.Text)
                    obj.GFID = iGrpFomul
    ...
    Protected Sub RadGrid_NeedDataSource(ByVal source As Object, ByVal e As GridNeedDataSourceEventArgs) Handles rgData.NeedDataSource
        ...
        Try
            ...
            rgData.VirtualItemCount = vListSalary.Rows.Count
...
#Region "Custom"
    ...
    Protected Sub LoadListAllSalary()
        ...
        Try
            vListSalary = rep.PRU_SYNCHFORMULAR(iGrpFomul)
            rgData.Rebind()
    ...
    Protected Sub LoadListInputColumn()
        ...
        Dim startTime As DateTime = DateTime.UtcNow
        Try
            Dim DS As DataSet = rep.GetListInputColumn(iGrpFomul)
            If DS IsNot Nothing AndAlso DS.Tables.Count > 0 Then

                vListInputColum = DS.Tables(0)
                ctrlListSalary.DataFieldID = "ID"
                ctrlListSalary.DataFieldParentID = "PARENT_ID"
                ctrlListSalary.DataTextField = "WNAME"
                ctrlListSalary.DataValueField = "WCODE"

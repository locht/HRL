...
//                    args.set_cancel(true);
        ...
        function OpenEditWindow() {
            ...
            var oWindow = radopen('Dialog.aspx?mid=Attendance&fid=ctrlSignWorkNewEdit&group=Business&FormType=1&noscroll=1&periodid=' + periodID, "rwPopup");
        ...
        function OpenDeleteWindow() {
            ...
            if (id > 0) {
                ...
                var oWindow = radopen('Dialog.aspx?mid=Attendance&fid=ctrlSignWorkDelete&group=Business&FormType=1&noscroll=1&ID=' + id + '&periodid=' + periodID, "rwPopup");

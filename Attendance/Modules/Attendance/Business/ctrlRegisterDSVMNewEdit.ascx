            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="rdWorkingday"
                        runat="server" ErrorMessage="<%$ Translate: Từ ngày chưa chọn. %>" ToolTip="<%$ Translate: Từ ngày chưa chọn. %>"> </asp:RequiredFieldValidator>
                </td>
                <td class="lb">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="cboTypeDmvs"
                        runat="server" ErrorMessage="<%$ Translate: Chưa chọn loại đăng ký. %>" ToolTip="<%$ Translate: Chưa chọn loại đăng ký. %>"> </asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="lb">
                ...
                <td>
                    <tlk:RadTimePicker ID="txtDenGio" runat="server" ShowPopupOnFocus="true" c>

...
Public Class ctrlAT_MngRegisters
    Inherits CommonView
...
#Region "Page"
    ...
    Public Overrides Sub ViewInit(e As System.EventArgs)
        ...
        Try
            Dim startTime As DateTime = DateTime.UtcNow
            ViewItem1 = Me.Register("ctrlRegisterCO", "Attendance", "ctrlRegisterCO", "Business")
            ViewItem2 = Me.Register("ctrlRegisterOT", "Attendance", "ctrlRegisterOT", "Business")
            ViewItem3 = Me.Register("ctrlRegisterDSVM", "Attendance", "ctrlRegisterDSVM", "Business")
            _myLog.WriteLog(_myLog._info, _classPath, method,
                          CLng(DateTime.UtcNow.Subtract(startTime).TotalSeconds).ToString(), Nothing, "")
        Catch ex As Exception
            _myLog.WriteLog(_myLog._error, _classPath, method, 0, ex, "")

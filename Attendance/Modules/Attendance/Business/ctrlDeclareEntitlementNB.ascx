                ...
                <tlk:RadGrid PageSize="50" ID="rgDeclareEntitlementNB" runat="server" SkinID="GridSingleSelect"
                    ...
                    <MasterTableView DataKeyNames="ID,ORG_DESC" ClientDataKeyNames="ID">
                        <Columns>
                            ...
                            <tlk:GridBoundColumn HeaderText="<%$ Translate: Mã nhân viên %>" HeaderStyle-Font-Bold="true"
                            ...
                            <tlk:GridNumericColumn HeaderText="<%$ Translate:Năm %>" DataField="YEAR" ItemStyle-HorizontalAlign="Center"

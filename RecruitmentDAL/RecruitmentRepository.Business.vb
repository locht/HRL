        ...
        Try
            Dim query = From p In Context.RC_PROGRAM
                        ...
                        Select New ProgramDTO With {
                                       ...
                                       .MAJOR_MAIN_ID = If(p.MAJOR_MAIN_ID Is Nothing, rec.QUALIFICATION, p.MAJOR_MAIN_ID),
                                       ...
                                       .LANGUAGE1_ID = If(p.LANGUAGE1_ID Is Nothing, rec.LANGUAGE, p.LANGUAGE1_ID),
                                       .LANGUAGE1_LEVEL_ID = If(p.LANGUAGE1_LEVEL_ID Is Nothing, rec.LANGUAGELEVEL, p.LANGUAGE1_LEVEL_ID),
                                       .LANGUAGE1_POINT = If(p.LANGUAGE1_POINT_ID Is Nothing, rec.LANGUAGESCORES, p.LANGUAGE1_POINT_ID),
